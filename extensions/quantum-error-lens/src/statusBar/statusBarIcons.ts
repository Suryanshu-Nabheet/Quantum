...
export class StatusBarIcons {
	...
	private readonly errorForegroundThemeColor = new ThemeColor('quantumErrorLens.statusBarIconErrorForeground');
	private readonly warningForegroundThemeColor = new ThemeColor('quantumErrorLens.statusBarIconWarningForeground');
	...
	constructor({
		...
		this.errorStatusBarItem = window.createStatusBarItem('quantumErrorLensError', statusBarAlignment, priority);
		this.errorStatusBarItem.name = 'Quantum Error Lens: Error icon';
		this.errorStatusBarItem.command = Constants.OpenProblemsViewCommandId;
		this.warningStatusBarItem = window.createStatusBarItem('quantumErrorLensWarning', statusBarAlignment, priority - 1);
		this.warningStatusBarItem.name = 'Quantum Error Lens: Warning icon';
