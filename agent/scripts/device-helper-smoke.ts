...
import { decodeDeviceFrame } from "@quantum/shared/deviceFrame";
import {
...
async function main(): Promise<void> {
  ...
  // comes from @quantum/shared so this build lands in the same directory the
  ...
  try {
    ...
    const socketDir = mkdtempSync(join(tmpdir(), "quantum-device-smoke-"));
