 ...
 *
 * This lives in `@quantum/shared` because two independent callers derive the
...
/** `~/Library/Caches/quantum/device-helper` — callers pass their own home dir. */
...
export const DEVICE_HELPER_BINARY_NAME = "quantum-device-helper";

/** Physical helper source directory passed from packaged desktop to its backend child. */
export const DEVICE_HELPER_SOURCE_DIR_ENV = "QUANTUM_DEVICE_HELPER_SOURCE_DIR";
