...
const PATH_CAPTURE_START = "__QUANTUM_PATH_START__";
const PATH_CAPTURE_END = "__QUANTUM_PATH_END__";
 ...
 */
export const SHELL_ENVIRONMENT_HYDRATED_ENV_NAME = "QUANTUM_PATH_HYDRATED";
...
function envCaptureStart(name: string): string {
  return `__QUANTUM_ENV_${name}_START__`;
}

function envCaptureEnd(name: string): string {
  return `__QUANTUM_ENV_${name}_END__`;
}
