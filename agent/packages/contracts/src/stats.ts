...
// the shareable activity card. All metrics are backed by Quantum's local DB
...
export const ProfileActivity = Schema.Struct({
  ...
  // totalPromptsSent), i.e. days the user actually used Quantum.
...
// Token totals come from Quantum's projected context-window updates. `available`
