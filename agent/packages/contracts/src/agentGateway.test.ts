...
import {
  QuantumCapabilitiesResult,
  QuantumCreateThreadsInput,
  QuantumCreateThreadsResult,
  QuantumGatewayErrorResult,
  QuantumWaitForThreadsInput,
  QuantumWaitForThreadsResult,
} from "./agentGateway";

const decodeCreate = Schema.decodeUnknownSync(QuantumCreateThreadsInput);
const decodeWait = Schema.decodeUnknownSync(QuantumWaitForThreadsInput);
...
describe("agent gateway contracts", () => {
  ...
  it("decodes typed capability, creation, wait, and error results", () => {
    assert.doesNotThrow(() =>
      Schema.decodeUnknownSync(QuantumCapabilitiesResult)({
        targetConstruction: {
          codex: {
    ...
    assert.doesNotThrow(() =>
      Schema.decodeUnknownSync(QuantumCreateThreadsResult)({
    ...
    assert.doesNotThrow(() =>
      Schema.decodeUnknownSync(QuantumWaitForThreadsResult)({
    ...
    assert.doesNotThrow(() =>
      Schema.decodeUnknownSync(QuantumGatewayErrorResult)({
