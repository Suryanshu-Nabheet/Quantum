...
export const WS_COMPATIBILITY_QUERY = {
  clientBuild: "x-quantum-client-build",
  protocolEpoch: "x-quantum-protocol-epoch",
  protocolRevision: "x-quantum-protocol-revision",
  serverInstanceId: "x-quantum-server-instance",
} as const;

export const WS_NEGOTIATE_QUERY = {
  clientBuild: "x-quantum-client-build",
  protocolEpoch: "x-quantum-protocol-epoch",
  minRevision: "x-quantum-protocol-min-revision",
  maxRevision: "x-quantum-protocol-max-revision",
  requiredCapability: "x-quantum-required-capability",
} as const;
