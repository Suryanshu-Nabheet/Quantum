...
// Unified cross-provider skills catalog (Quantum portable skills). Descriptors use
// `scope` to carry the origin label ("quantum", "codex", "claude", "cursor", ...).
...
export const ProviderSkillsCatalogResult = Schema.Struct({
  skills: Schema.Array(ProviderSkillDescriptor),
  quantumSkillsDir: Schema.optional(TrimmedNonEmptyString),
});
