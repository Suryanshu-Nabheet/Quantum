#!/bin/bash
# Compiles quantum-device-helper with the user's own Xcode toolchain.
#
...
#   QUANTUM_DEVICE_HELPER_OUT=/path build.sh
#
...
OUT_DIR="${1:-${QUANTUM_DEVICE_HELPER_OUT:-$SOURCE_DIR/build}}"
BINARY_NAME="quantum-device-helper"
