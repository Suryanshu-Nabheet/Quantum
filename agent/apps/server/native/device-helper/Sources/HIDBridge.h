...
typedef NS_ENUM(NSInteger, QuantumHardwareButton) {
  QuantumHardwareButtonHome,
  QuantumHardwareButtonLock,
  QuantumHardwareButtonSide,
  QuantumHardwareButtonSiri,
  QuantumHardwareButtonVolumeUp,
  QuantumHardwareButtonVolumeDown,
};
...
@interface QuantumHIDBridge : NSObject
...
- (void)tapButton:(QuantumHardwareButton)button NS_SWIFT_NAME(tapButton(_:));
