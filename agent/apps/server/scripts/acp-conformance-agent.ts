...
const logPath = process.env.QUANTUM_ACP_CONFORMANCE_LOG_PATH;
const malformedPrefix = process.env.QUANTUM_ACP_CONFORMANCE_MALFORMED_PREFIX === "1";
...
const app = agent({ name: "quantum-official-sdk-conformance-agent" })
