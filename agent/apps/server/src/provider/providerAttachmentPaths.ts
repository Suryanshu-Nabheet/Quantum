...
import type { ChatAttachment, ProviderKind, ThreadId } from "@quantum/contracts";
...
const PROVIDER_ATTACHMENT_STORAGE_PATH = Symbol("quantum.providerAttachmentStoragePath");
