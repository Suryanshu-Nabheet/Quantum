...
export interface AcpSessionRuntimeOptions {
   ...
   * `mcpCapabilities` (e.g. HTTP vs stdio for the Quantum agent gateway).
   */
...
/**
 * Bridges Effect's child-process exit signal into Quantum's process-tree proof. This is deliberately
...
>()("quantum/provider/acp/AcpSessionRuntime") {
  static layer(
