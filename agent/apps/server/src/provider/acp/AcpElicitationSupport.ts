...
// Purpose: Bridges ACP form elicitation schemas to Quantum's provider-neutral question UI.
...
// Converts primitive ACP form fields into the question shape consumed by Quantum's composer.
