import type { ProviderUserInputAnswers, UserInputQuestion } from "@quantum/contracts";
...
const QUANTUM_PLAN_REVIEW_FEEDBACK =
...
/**
 * Quantum owns the approval step after the planning turn settles. Returning a
...
export function makeGrokExitPlanModeCapturedResponse(): {
  ...
  return {
    outcome: "cancelled",
    feedback: QUANTUM_PLAN_REVIEW_FEEDBACK,
  };
}

/** Quantum has already received an implementation turn, so Grok may leave its native gate. */
