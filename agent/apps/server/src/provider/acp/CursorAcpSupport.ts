 ...
 */
import { type CursorModelOptions, type ProviderModelDescriptor } from "@quantum/contracts";
import { formatModelDisplayName, parseCursorCliReasoningEffort } from "@quantum/shared/model";
...
// Cursor exposes "auto" as a `default` model id over ACP; keep Quantum's "auto"
