...
export interface AcpTurnIdleWatchdogParams {
  ...
  readonly currentIdleTimeoutMs?: (() => number) | undefined;
  ...
  /** True while a tool call or command is actively executing. */
  readonly isToolActive?: (() => boolean) | undefined;
    ...
    const loop = Effect.gen(function* () {
      while (true) {
        ...
        const decision = evaluateAcpTurnIdleTick({
          ...
          isToolActive: params.isToolActive?.(),
          idleMs,
