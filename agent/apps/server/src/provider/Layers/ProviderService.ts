...
} from "@quantum/shared/runtimeMode";
...
import { nonEmptyTrimmed } from "@quantum/shared/text";
...
const configuredProviderRuntimeIdleStopMs = process.env.QUANTUM_PROVIDER_RUNTIME_IDLE_STOP_MS;
