...
import { doThreadMarkerRangesOverlap } from "@quantum/shared/threadMarkers";
import { collectSubagentDescendants } from "@quantum/shared/threadHierarchy";
import { autoRuntimeModeSelectionIssue } from "@quantum/shared/runtimeMode";
...
> {
  switch (command.type) {
    ...
    case "thread.create": {
      ...
      // Quantum never starts a session for them, so the Auto-mode capability
