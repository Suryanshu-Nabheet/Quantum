...
import { CommandId, ProjectId, SpaceId, type OrchestrationCommand } from "@quantum/contracts";
...
describe("Spaces", () => {
  ...
  it("rejects filing a legacy Home chat container into a space", async () => {
    ...
    const workspacePaths = {
      homeDir: "/Users/dev",
      chatWorkspaceRoot: "/Users/dev/Documents/Quantum/Chats",
    };
    let readModel = createEmptyReadModel(createdAt);
    ...
    ({ readModel } = await dispatch(readModel, {
      ...
      title: "Quantum",
      workspaceRoot: "/Users/dev/code/quantum",
      createdAt,
    }));
