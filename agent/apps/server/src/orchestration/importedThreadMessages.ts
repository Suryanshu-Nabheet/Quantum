...
// Purpose: Normalizes provider-native transcript snapshots into Quantum import messages.
...
import { MessageId, type ThreadHandoffImportedMessage, type ThreadId } from "@quantum/contracts";
