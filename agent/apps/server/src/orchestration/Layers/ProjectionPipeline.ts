import { ApprovalRequestId, CommandId, type OrchestrationEvent } from "@quantum/contracts";
import {
  addPinnedMessage,
  removePinnedMessage,
...
import { isStalePendingRequestFailureDetail } from "@quantum/shared/threadSummary";
...
const makeOrchestrationProjectionPipeline = Effect.gen(function* () {
  ...
  const appendStreamingThreadMessageText = (
    ...
    projectionThreadMessageRepository.appendStreamingText({
      threadId: event.payload.threadId,
