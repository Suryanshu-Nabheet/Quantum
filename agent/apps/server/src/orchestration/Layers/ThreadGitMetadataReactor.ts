import { CommandId, type ProviderRuntimeEvent, type ThreadId } from "@quantum/contracts";
import {
  makeDrainableWorker,
...
const make = Effect.gen(function* () {
  ...
  const processProviderEvent = (event: ProviderRuntimeEvent) => {
    // Native subagent lifecycle events carry the parent Quantum thread id and the child identity
