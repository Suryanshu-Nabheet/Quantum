/**
 * AgentGatewayCredentials - Per-session credentials for the Quantum agent
 * gateway.
 *
...
export interface AgentGatewayCredentialsShape {
  /** Streamable-HTTP MCP endpoint served by this Quantum instance. */
...
>()("quantum/agentGateway/Services/AgentGatewayCredentials") {}
