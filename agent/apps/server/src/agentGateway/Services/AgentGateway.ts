/**
 * AgentGateway - Quantum app-control tool surface for provider agents.
 *
 * Serves the `quantum_*` MCP tools that let any provider session (Codex,
 * Claude, Grok, ...) inspect and control Quantum itself: list projects and
...
export class AgentGateway extends ServiceMap.Service<AgentGateway, AgentGatewayShape>()(
  "quantum/agentGateway/Services/AgentGateway",
) {}
