...
} from "@quantum/shared/browserAutomationCatalogue";
import { makeBrowserAutomationError } from "@quantum/shared/browserAutomationErrors";
import { encodeBrowserMcpToolError } from "@quantum/shared/browserAutomationMcpError";
...
function withGatewayIdempotencyKey(
  ...
  return {
    ...argumentsValue,
    idempotencyKey: `quantum-mcp-${digest.slice(0, 40)}`,
  };
}
