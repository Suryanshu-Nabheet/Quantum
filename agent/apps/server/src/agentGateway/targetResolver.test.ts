...
import type { ModelSelection, ProviderKind, ProviderModelDescriptor } from "@quantum/contracts";
...
describe("agent gateway target resolver", () => {
  ...
  it.effect("fails closed before discovery when Quantum disables a provider", () =>
    Effect.gen(function* () {
