...
/**
 * Providers whose sessions run without a per-tool approval gate. Quantum cannot
  ...
  const tools: ToolEntry[] = [
    {
      ...
      definition: {
        name: "device_list",
        description:
          "List iOS simulators Quantum can drive, with their runtime, boot state, and who booted them. Call this before any other device_* tool to get a udid.",
        inputSchema: {
          type: "object",
          properties: {
            includeShutdown: {
    ...
    },
    {
      ...
      definition: {
        name: "device_boot",
        description:
          'Boot a simulator. Quantum caps the number of simulators it boots itself; past the cap this returns kind "boot-limit-reached" with the devices to shut down, which is a refusal to relay to the user, not an error to retry.',
        inputSchema: {
          type: "object",
    ...
    },
    {
      ...
      definition: {
        name: "device_install",
        description:
          "Install a built .app bundle on a booted simulator. Quantum never builds the app: run your own build first and pass the resulting bundle path.",
        inputSchema: {
          type: "object",
          properties: {
            udid: UDID_PROPERTY,
