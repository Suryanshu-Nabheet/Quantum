 ...
 * names. Because the migrator skips by ID, Quantum migrations 17-31 never run
 ...
 * Quantum migrations known at the time, but predecessor trackers eventually
 ...
 *
 * Idempotent and a no-op for fresh Quantum installs (every column already
