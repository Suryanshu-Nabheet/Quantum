import { EventId, IsoDateTime, NonNegativeInt, ThreadId } from "@quantum/contracts";
...
>()(
  "quantum/persistence/Services/OrchestrationEventDeliveries/OrchestrationEventDeliveryRepository",
) {}
