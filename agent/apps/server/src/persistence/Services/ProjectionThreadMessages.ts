...
export const AppendStreamingThreadMessageTextInput = Schema.Struct({
  threadId: ThreadId,
  messageId: MessageId,
  turnId: Schema.optional(Schema.NullOr(TurnId)),
  role: OrchestrationMessageRole,
  text: Schema.String,
  dispatchOrigin: Schema.optional(Schema.NullOr(MessageDispatchOrigin)),
  dispatchMode: Schema.optional(Schema.NullOr(TurnDispatchMode)),
  source: Schema.optional(OrchestrationMessageSource),
  sequence: Schema.optional(NonNegativeInt),
  updatedAt: Schema.optional(IsoDateTime),
});
export type AppendStreamingThreadMessageTextInput =
  typeof AppendStreamingThreadMessageTextInput.Type;
...
export interface ProjectionThreadMessageRepositoryShape {
  ...
  /**
   * Append streaming text to an existing thread message row.
   */
  readonly appendStreamingText: (
    input: AppendStreamingThreadMessageTextInput,
...
>()("quantum/persistence/Services/ProjectionThreadMessages/ProjectionThreadMessageRepository") {}
