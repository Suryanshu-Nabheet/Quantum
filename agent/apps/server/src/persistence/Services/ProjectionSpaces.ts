...
import { IsoDateTime, NonNegativeInt, SpaceIconName, SpaceId, SpaceName } from "@quantum/contracts";
...
>()("quantum/persistence/Services/ProjectionSpaces/ProjectionSpaceRepository") {}
