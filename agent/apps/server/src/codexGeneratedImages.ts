...
import { isSupportedLocalImagePath as isSupportedLocalImagePathShared } from "@quantum/shared/localPreviewFiles";
 ...
 * writes images under for the current process env. Quantum uses its isolated
 ...
 * overlay `<QUANTUM_HOME>/codex-home-overlay/generated_images` so we serve
