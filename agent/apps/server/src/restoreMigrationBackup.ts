...
const USAGE = "Usage: quantum-restore-migration-backup <absolute-database-path>";
const STOP_PROCESSES_WARNING =
  "WARNING: Stop every Quantum process before restoring a migration backup.";
...
const entryPointNames = new Set([
  ...
  "quantum-restore-migration-backup",
]);
