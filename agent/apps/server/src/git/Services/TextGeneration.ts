...
export class CodexTextGeneration extends ServiceMap.Service<
  CodexTextGeneration,
  TextGenerationShape
>()("quantum/git/Services/TextGeneration/CodexTextGeneration") {}
...
export class OpenCodeTextGeneration extends ServiceMap.Service<
  ...
  TextGenerationShape
>()("quantum/git/Services/TextGeneration/OpenCodeTextGeneration") {}
...
export class KiloTextGeneration extends ServiceMap.Service<
  KiloTextGeneration,
  TextGenerationShape
>()("quantum/git/Services/TextGeneration/KiloTextGeneration") {}
