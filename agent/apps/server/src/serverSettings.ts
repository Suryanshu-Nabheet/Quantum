...
import { deepMerge, type DeepPartial } from "@quantum/shared/Struct";
import { applyServerSettingsPatch } from "@quantum/shared/serverSettings";
import {
  Cause,
  Deferred,
  Effect,
...
export class ServerSettingsService extends ServiceMap.Service<
  ...
  ServerSettingsShape
>()("quantum/serverSettings/ServerSettingsService") {
