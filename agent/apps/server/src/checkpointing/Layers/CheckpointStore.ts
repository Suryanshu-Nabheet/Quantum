  ...
  const captureCheckpointOnce: CheckpointStoreShape["captureCheckpoint"] = (input) =>
    Effect.gen(function* () {
      ...
      yield* Effect.acquireUseRelease(
        fs.makeTempDirectory({ prefix: "quantum-fs-checkpoint-" }),
        (tempDir) =>
          Effect.gen(function* () {
            ...
            const commitEnv: NodeJS.ProcessEnv = {
              ...
              GIT_AUTHOR_NAME: "Quantum",
              GIT_AUTHOR_EMAIL: "quantum@users.noreply.github.com",
              GIT_COMMITTER_NAME: "Quantum",
              GIT_COMMITTER_EMAIL: "quantum@users.noreply.github.com",
            };
            ...
            const message = `Quantum checkpoint ref=${input.checkpointRef}`;
  ...
  const reverseCheckpointDiff: CheckpointStoreShape["reverseCheckpointDiff"] = (input) =>
    Effect.gen(function* () {
      ...
      return yield* Effect.acquireUseRelease(
        fs.makeTempDirectory({ prefix: "quantum-checkpoint-undo-" }),
        (tempDir) =>
          Effect.gen(function* () {
