...
import { EDITORS, type EditorId } from "@quantum/contracts";
...
type KnownEditorDefinition = (typeof EDITORS)[number];

function resolveEditor(editorId: string): KnownEditorDefinition | null {
