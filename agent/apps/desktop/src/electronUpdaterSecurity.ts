...
} from "@quantum/shared/windowsCertificate";
import {
  prepareWindowsSafeProcess,
  resolveWindowsSystemRoot,
} from "@quantum/shared/windowsProcess";

export { parseDistinguishedName } from "@quantum/shared/windowsCertificate";
...
export function hardenElectronUpdater(
  ...
  const prototype =
    typeof updaterModule.BaseUpdater === "function"
      ...
      : null;
  if (prototype && !prototype.__quantumSpawnSyncLogPatched) {
    ...
    prototype.__quantumSpawnSyncLogPatched = true;
  }
