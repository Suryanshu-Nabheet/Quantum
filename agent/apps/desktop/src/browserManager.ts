...
import { isBrowserCopyLinkChord } from "@quantum/shared/browserShortcuts";
import {
...
export class DesktopBrowserManager {
  ...
  private scheduleWindowOpenTab(input: {
    ...
    // runtimes. Only the first decision may create a canonical Quantum tab.
    if (
  ...
  attachWebview(input: BrowserAttachWebviewInput, hostWebContentsId: number): ThreadBrowserState {
    ...
    if (
      ...
      throw new Error("The browser webview does not belong to this Quantum window and partition.");
    }
