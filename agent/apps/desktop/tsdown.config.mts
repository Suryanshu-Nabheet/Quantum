...
const sourcemapEnv = process.env.QUANTUM_DESKTOP_SOURCEMAP?.trim().toLowerCase();
...
export default defineConfig([
  {
    ...
    define: {
      __QUANTUM_WINDOWS_UPDATER_PUBLISHER__: JSON.stringify(windowsUpdaterPublisher),
    },
    noExternal: (id) => id.startsWith("@quantum/"),
  },
  {
    ...shared,
