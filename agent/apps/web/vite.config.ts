// FILE: vite.config.ts
// Purpose: Builds the Quantum web client and controls diagnostic source maps.
...
const sourcemapEnv = process.env.QUANTUM_WEB_SOURCEMAP?.trim().toLowerCase();
...
function centralIconPrunePlugin(): Plugin {
  ...
  return {
    name: "quantum-central-icon-prune",
    apply: "build",
