...
// Layer: Web UI state
// Why: "Void" is Quantum's word for "not filed yet", and it is the one Space label a user
...
import { SPACE_NAME_MAX_LENGTH } from "@quantum/contracts";
...
const STORAGE_KEY = "quantum:void-space:v1";
