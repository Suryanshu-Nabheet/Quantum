...
describe("project filter", () => {
  ...
  it("merges every project-less chat container into one Quantum scope", () => {
...
describe("resolveActivityScope", () => {
  ...
  it("expands the Quantum chats scope to its container projects", () => {
...
describe("resolveThreadProjectLabel", () => {
  it("uses the project name for real projects and Quantum otherwise", () => {
    expect(
      resolveThreadProjectLabel({ kind: "project", name: "Quantum App", folderName: "quantum" }),
    ).toBe("Quantum App");
    expect(resolveThreadProjectLabel({ kind: "chat", name: "Chats", folderName: "chats" })).toBe(
      "Quantum",
    );
    expect(resolveThreadProjectLabel(undefined)).toBe("Quantum");
  });
});
