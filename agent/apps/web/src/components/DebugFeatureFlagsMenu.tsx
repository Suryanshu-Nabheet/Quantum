...
function triggerActionFailedToasts(values: Record<ToggleFeatureFlagId, boolean>): void {
  const copyText =
    "Error: Git command failed in /Users/ibrahime/Documents/Projects/quantum\n\n" +
  ...
  toastManager.add({
    type: "error",
    title: "Action failed",
    description: "Error: Git command failed in /Users/ibrahime/Documents/Projects/quantum",
    data: toastData,
  });
  toastManager.add({
    type: "error",
