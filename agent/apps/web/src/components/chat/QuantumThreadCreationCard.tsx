// FILE: QuantumThreadCreationCard.tsx
// Purpose: End-of-turn recap for threads created through the Quantum MCP harness.
...
export const QuantumThreadCreationCard = memo(function QuantumThreadCreationCard({
  creation,
  onOpenThread,
}: {
  readonly creation: WorkLogQuantumThreadCreation;
  ...
  return (
    <div
      ...
      data-quantum-thread-creation-card="true"
    >
      <div className="flex min-w-0 items-center gap-3 px-3 py-2.5">
        <span className="flex size-10 shrink-0 items-center justify-center rounded-lg bg-[var(--color-background-elevated-secondary)] text-foreground">
          <QuantumLogo className="h-[22px] w-auto" aria-label="Quantum" />
        </span>
