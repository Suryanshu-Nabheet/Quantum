...
import { isTemporaryWorktreeBranch, resolveUniqueQuantumBranchName } from "@quantum/shared/git";
...
export function resolveDefaultCreateBranchName(
  ...
  return resolveUniqueQuantumBranchName(existingBranchNames, preferredBranch);
}
...
export { resolveAutoFeatureBranchName } from "@quantum/shared/git";
