...
import type { GitBranch, GitStashInfoResult, GitStatusResult, NativeApi } from "@quantum/contracts";
            ...
            try {
              ...
              if (isStashConflictError(stashError)) {
                ...
                addBranchRecoveryToast({
                  ...
                  description:
                    "Quantum switched branches and kept your changes in a stash because they could not be restored onto this branch cleanly.",
