...
import { automationRequiresTargetThread } from "@quantum/shared/automationMode";
import { respondingInteractionReclaimAt } from "@quantum/shared/pendingInteractions";
import { providerSupportsNativeTurnSteering } from "@quantum/shared/providerMetadata";
import { getModelCapabilities, normalizeModelSlug } from "@quantum/shared/model";
import {
  resolveLatestTailUserMessageEditTarget,
  resolveTailUserMessageEditTarget,
} from "@quantum/shared/conversationEdit";
import { threadExportBlockedReason } from "@quantum/shared/threadExport";
import { pendingRequestInstanceKey } from "@quantum/shared/threadSummary";
import {
  buildPromptThreadTitleFallback,
  GENERIC_CHAT_THREAD_TITLE,
} from "@quantum/shared/chatThreads";
import {
...
import {
  ...
  workspaceRootsEqual,
} from "@quantum/shared/threadWorkspace";
import {
  lazy,
  Suspense,
  useCallback,
...
import { buildTemporaryWorktreeBranchName } from "@quantum/shared/git";
import {
...
// back-and-forth (user request, Quantum's clarifying questions) inline like Codex.
        ...
        if (serverThread) {
          ...
          if (!api) {
            toastManager.add({
              ...
              description: "Quantum is not connected to the server.",
            });
            return false;
          }
    ...
    (style: ThreadMarkerStyle, color: ThreadMarkerColor) => {
      ...
      if (!range) {
        toastManager.add({
          ...
          description: "Try including a few more words so Quantum can find the exact place.",
        });
        return;
      }
      dismissTranscriptSelectionAction();
      ...
      return await (async () => {
          ...
          void (async () => {
            try {
              ...
              toastManager.add({
                ...
                description:
                  "The automation was created, but Quantum could not add the activity note.",
              });
            }
          })();
        }
        ...
        .catch((error: unknown) => {
          toastManager.add({
            ...
            description:
              error instanceof Error ? error.message : "Quantum could not save the automation.",
          });
          return false;
        })
        .finally(() => {
      ...
      const promoteDraftForAutomation = async (): Promise<ThreadId | null> => {
        ...
        if (result === "unavailable") {
          toastManager.add({
            ...
            description: "Quantum could not promote this draft before saving the automation.",
          });
          return null;
        }
      ...
      try {
        ...
        toastManager.add({
          ...
          description:
            error instanceof Error
              ? error.message
              : "Quantum could not promote this draft before saving the automation.",
        });
        return null;
      }
    },
            ...
            {shouldRenderChatPaneContent && isCenteredEmptyLanding ? (
              ...
              >
                ...
                <div className="flex w-full flex-col justify-center">
                  ...
                  >
                    <QuantumLogo aria-label="Quantum logo" className="size-10" />
                    <h2
