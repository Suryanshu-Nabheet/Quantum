...
import { type GitHubProjectProvisionProgressEvent, type SpaceId } from "@quantum/contracts";
import { parseGitHubRepositoryInput } from "@quantum/shared/githubRepository";
...
export function CreateProjectDialog(props: {
  ...
  const submit = async () => {
    ...
    if (source === "github" && !props.githubProvisioningAvailable) {
      setFormError("Update the Quantum server before adding a project from GitHub.");
      return;
    }
