    ...
    <div className="space-y-6">
      {!setup ? (
        <SettingsSection title="Connect a coding agent">
          <SettingsRow
            title="Name"
            description="How this connection appears in Quantum. Works with Codex, Claude, and any other MCP-capable agent."
            control={
              <Input
      ...
      {setup && setupIntegration && setupPrompt && manualConfiguration && examplePrompt ? (
        <SettingsSection title={`Connect ${setupIntegration.name}`}>
          <SettingsRow
            ...
            description={
              revoked
                ? "This connection has been revoked and can no longer access Quantum."
                : integrationExpired
                  ? "This connection has expired and can no longer access Quantum."
                  : connected
          ...
          <SettingsRow
            ...
            description="Copy the prompt and paste it into the agent you want to connect (Codex, Claude Code, or any MCP-capable app). The agent pairs this computer, registers Quantum in its own configuration, and verifies the connection by itself."
            status={
              paired
          ...
          <SettingsRow
            ...
            status={
              connected
                ? "Connection verified by Quantum."
                : "Quantum will show Connected after the agent makes its first request."
            }
            control={
              <Button
                size="xs"
