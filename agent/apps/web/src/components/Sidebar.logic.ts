...
import { resolveThreadEnvironmentMode } from "@quantum/shared/threadEnvironment";
import { isWorkspaceRootWithin, workspaceRootsEqual } from "@quantum/shared/threadWorkspace";
...
export const DEBUG_FEATURE_FLAGS_MENU_STORAGE_KEY = "quantum:show-debug-feature-flags-menu";
 ...
 * without going through Quantum's branch picker. In that case the worktree's checked-out branch
