...
/**
 * The compact raised-thumb picker previously used for the Quantum/Studio switch,
        ...
        {PROJECT_SOURCES.map((source, index) => {
          ...
          return (
            <button
              ...
              title={
                sourceUnavailable ? "Update the Quantum server to add GitHub projects." : undefined
              }
              className={cn(
