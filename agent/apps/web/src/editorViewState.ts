...
import type { ProjectId, ProviderKind, ThreadId } from "@quantum/contracts";
import { isProviderKind } from "./providerOrdering";

const EDITOR_VIEW_STATE_STORAGE_KEY = "quantum.editor.viewStateByThreadId";
const EDITOR_RAIL_CHAT_TABS_STORAGE_KEY = "quantum.editor.railChatTabsByProjectId";
