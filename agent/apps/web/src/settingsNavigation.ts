...
export const SETTINGS_NAV_ITEMS: readonly SettingsNavItem[] = [
  ...
  },
  {
    ...
    group: "personal",
    label: "Profile",
    description: "Your activity, streaks, and a shareable stats card.",
    icon: "user",
    eyebrow: "Your stats",
  },
  {
  ...
  },
  {
    ...
    group: "personal",
    label: "Notifications",
    description: "Choose how Quantum tells you when work finishes or needs attention.",
    icon: "bell",
    eyebrow: "Alerts",
  },
  {
  ...
  },
  {
    ...
    group: "personal",
    label: "Keybindings",
    description: "Capture, customize, and add shortcuts for every Quantum command.",
    icon: "shortcut",
  ...
  },
  {
    ...
    description: "Give Codex, Claude, and other agents scoped access to Quantum tasks.",
    icon: "plugin-1",
  ...
  },
  {
    ...
    description: "Review and clean up isolated workspaces created by Quantum.",
    icon: "branch-simple",
