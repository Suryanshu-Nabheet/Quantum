...
export const WHATS_NEW_ENTRIES: readonly WhatsNewEntry[] = [
    ...
    features: [
      {
        ...
        description:
          "Quantum now keeps waiting for a healthy backend and recovers late connections instead of giving up while a large history is still loading.",
        details:
      ...
      },
      {
        ...
        description:
          "Workspace previews are now useful for small code and text edits without leaving Quantum.",
        details:
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        description:
          "Completion alerts stay quiet while Quantum is in front of you, and provider update notices refresh more reliably when you return.",
        details:
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        details:
          "Human interactions are now fenced to the owning provider request and turn across Claude and OpenCode. Resolved guards remain resolved, stale cross-turn requests are ignored, retryable interactions stay visible, and OpenCode permission replies wait for a real acknowledgement before Quantum clears them.",
      },
      {
        id: "provider-skills-and-models",
        title: "Installed skills and favourite models stay discoverable",
        description:
          "Quantum now finds installed Claude plugin skills and keeps similarly named favourite models tied to the correct provider.",
        details:
      ...
      },
      {
        ...
        description:
          "Quantum no longer treats interrupted or errored work as a successful completion or repeats an alert as timestamps change.",
        details:
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        description:
          "Quantum negotiates one authenticated connection, compresses large traffic, and resumes thread detail from a cursor when possible.",
        details:
    ...
    features: [
      {
        ...
        description:
          "Interrupt and stop actions now take priority over new work, even when a busy Quantum server has filled its ordinary command queue.",
        details:
      ...
      },
      {
        ...
        details:
          "Quantum retains enough turn identity to settle late Claude results, fences stale lifecycle generations, reconciles durable provider commands and runtime events, and aligns Codex, Claude, Cursor, and ACP session ownership through start, stop, reconnect, and restart boundaries.",
      },
      {
    ...
    features: [
      {
        ...
        details:
          "Quantum now normalizes live and settled tool activity into one presentation model, preserves expandable tool details and interactions, and reconciles terminal states without leaving duplicate or permanently running work rows behind.",
      },
      {
      ...
      },
      {
        ...
        details:
          "Quantum abandons ambiguous blockers oldest-first, then replays only the skipped turn starts. This restores the conversation without risking a duplicate resend of the command whose delivery could not be proven.",
      },
      {
      ...
      },
      {
        ...
        description:
          "Quantum loads expensive provider and diff machinery only when needed and computes working-tree statistics without transferring full patches.",
        details:
      ...
      },
      {
        ...
        details:
          "Database access now proves exclusive ownership, migration backups and resumable artifacts receive broader retention and reclamation coverage, and orphan cleanup stays bounded to verified Quantum-owned paths.",
      },
      {
    ...
    features: [
      {
        ...
        description:
          "Quantum now detects and repairs the database state that could leave some 0.6.0 installations stuck during startup.",
        details:
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        title: "Quantum's agents can now operate Quantum",
        description:
          "Every supported agent running inside Quantum receives built-in tools to understand the app, delegate work, coordinate parallel tasks, inspect failures, and manage automations.",
        details:
          "The new Quantum Agent Gateway can list and read projects and tasks, create one task or an exact multi-agent batch across providers and models, wait for every result, continue or interrupt work, rename or archive tasks, inspect runtime diagnostics, and manage automation lifecycles. Thread-bound authority, privilege caps, idempotent creation, isolated worktrees, and restart recovery keep delegated work visible and contained.",
      },
      {
        id: "project-spaces",
      ...
      },
      {
        ...
        description:
          "Follow Claude's native subagents and dynamic workflows as real Quantum work, with live status, phases, tools, usage, steering, and background controls.",
        details:
      ...
      },
      {
        ...
        description:
          "Mention an existing Quantum task from the composer to give the current agent the right recent context without copying a transcript by hand.",
        details:
      ...
      },
      {
        ...
        details:
          "Quantum prefetches provider models before the composer opens, avoids a redundant first-turn Claude permission wait, prepares Codex overlays without blocking, parallelizes independent turn-start I/O, reduces streaming SQL work, and expands React Compiler coverage across the web app.",
      },
      {
        ...
        details:
          "Highlights include Fable 5 and Opus 4.8 in Pi, namespaced Cursor and Grok model support, accurate Claude context windows, official ACP SDK handling, app-owned OpenCode review commands, isolated Codex child events, safer provider updates, preserved blank PATH defaults, and an Antigravity hook that no longer launches Quantum unexpectedly.",
      },
      {
    ...
    features: [
      {
        ...
        title: "Antigravity joins Quantum",
        description:
        ...
        details:
          "The new provider adapter covers installation and authentication guidance, model and effort discovery, session creation and resume, tool and plan events, permission requests, usage reporting, cancellation, and restart recovery. Quantum also includes dedicated Antigravity branding throughout provider setup and selection.",
      },
      {
      ...
      },
      {
        ...
        details:
          "Model-catalog queries retain successful and cached data when one Cursor discovery path fails, while pull-request data is coalesced through shared list logic and picker popups use a unified interaction model. Diff headers now use Quantum's own visual chrome for a more consistent workspace.",
      },
    ],
  },
  {
    ...
    features: [
      {
        ...
        title: "Review pull requests without leaving Quantum",
        description:
      ...
      },
      {
        ...
        description:
          "Quantum restores the previous desktop window size, position, and maximized state while keeping reopened windows on a visible display.",
        details:
    ...
    features: [
      {
        ...
        description:
          "Press both Option keys to capture the window you are using and attach it to the current Quantum task.",
        details:
    ...
    features: [
      {
        ...
        description:
          "Droid is now available alongside Quantum's other agents, with runtime model discovery, session import, token multipliers, and resilient resume and recovery.",
        details:
          "Quantum now connects to Factory Droid through ACP, discovers models and their switching capabilities at runtime, imports existing Droid sessions, carries context across forks and restarts, and keeps bootstrap, configuration, and turn teardown state coherent. The release also adds the Factory logo and richer Droid token reporting.",
      },
      {
  ...
  },
  {
    ...
    features: [
      {
        id: "quantum-identity",
        title: "Quantum, all the way through",
        description:
        ...
        details:
          "The desktop bundle is now com.suryanshunabheet.quantum, the CLI is @quantum/cli with the quantum command, and every first-party runtime identifier uses the Quantum namespace. The 0.4.2 bridge preserves renderer state during the origin change.",
      },
      {
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        description:
          "Quantum checks that an update actually installed after restart, detects failed installs, and recovers instead of silently staying on the old version.",
        details:
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        description:
          "Quantum is more careful about restoring the right destination after reloads, segment switches, reconnects, and partially completed project creation.",
        details:
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        description:
          "When Claude reports usage or rate-limit trouble, Quantum now presents the condition more calmly instead of turning it into a generic provider failure.",
        details:
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        description:
          "Quantum is better at shutting down stubborn terminal process trees without returning early while child processes are still alive.",
        details:
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        description:
          "Quantum avoids unnecessary provider refresh work during startup and gates Claude keepalive behavior more carefully, so opening the app is calmer and less likely to fight credential checks.",
        details:
    ...
    features: [
      {
        ...
        description:
          "When Quantum is downloading a desktop update, the sidebar update button now shows a live percent badge so you can tell whether it is moving or nearly ready.",
        details:
      ...
      },
      {
        ...
        description:
          "Quantum preserves the first pre-turn snapshot more carefully, so transcript diffs and restore points better match what was on disk when you pressed send.",
        details:
    ...
    features: [
      {
        ...
        description:
          "Quantum now finds Cursor agent commands across more install layouts, including bundled sibling shims and legacy shim locations, while rejecting unsafe fallbacks.",
        details:
      ...
      {
        id: "muxy-open-in",
        title: "Muxy can open from Quantum",
        description:
      ...
      },
      {
        ...
        description:
          "Quantum refreshes Claude credential freshness on macOS so long sessions are less likely to hit the familiar stale-token sign-in failure.",
        details:
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        details:
          "Quantum now reuses the central robot glyph for agent chips, improves file-change and tool-call labels, refines chat card contrast, and tightens shared switch sizing, thumb travel, and animation.",
      },
      {
    ...
    features: [
      {
        ...
        description:
          "Quantum can now launch VS Code Store installs through the right Windows app identity and URI fallback, so editor buttons work even when the normal `code` command is unavailable.",
        details:
      ...
      },
      {
        ...
        description:
          "A new settings toggle lets you disable provider update checks when you want Quantum to stay quieter about external CLI versions.",
        details:
      ...
      },
      {
        ...
        title: "The app icon and Quantum mark look cleaner",
        description:
          "The desktop, web, marketing, and release assets were refreshed so the Quantum icon renders more consistently across macOS, Windows, browser favicons, and update artifacts.",
        details:
          "This release refreshes the inline Quantum logo path, replaces generated icon assets from the full source image, corrects macOS bundle icon handling after the rounded-icon Ventura pass, and removes a literal Dock-icon workaround that was not the final direction.",
      },
      {
    ...
    features: [
      {
        ...
        description:
          "The branch toolbar can now show and change the active project, so project, branch, and worktree context are easier to keep aligned while you move around Quantum.",
        details:
      ...
      },
      {
        ...
        details:
          "Quantum now builds file diff trees, renders a collapsible review panel with shared disclosure motion, and reuses file-row styling so review navigation feels closer to the rest of the workspace.",
      },
      {
    ...
    features: [
      {
        ...
        details:
          "Quantum now formats tool command transcripts, normalizes patch/change output, labels more tool kinds consistently, preserves structured work metadata through the timeline, and adds focused coverage for tool-call labels and formatting.",
      },
      {
        id: "transcript-flow",
      ...
      },
      {
        ...
        details:
          "Quantum now ships a curated central-icons set, improves provider/model picker presentation, refines composer picker and automation banners, adds better project/thread hover details, and keeps repeated UI surfaces closer to the same visual language.",
      },
    ],
  },
  {
    ...
    features: [
      {
        ...
        description:
          "Quantum now has first-class Automations for scheduled agent work, with sidebar navigation, list/detail pages, run history, triage actions, and inline editing.",
        details:
    ...
    features: [
      {
        ...
        description:
          "Quantum now waits for one fresh server snapshot before giving up on a remembered chat route, so app restarts are less likely to dump you onto an empty fallback screen.",
        details:
    ...
    features: [
      {
        ...
        title: "Your Quantum profile has more personality",
        description:
          "Profile settings now include richer identity details, activity stats, and a cleaner editing flow so Quantum feels more like your own workspace.",
        details:
      ...
      },
      {
        ...
        details:
          "Quantum now tracks thread retention state explicitly, covers soft-delete cleanup behavior with server tests, and keeps deletion/recovery semantics more predictable for early WIP data.",
      },
      {
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        description:
          "After provider restarts, reconnects, or quiet ACP sessions, Quantum does a better job of reconciling active turns and finishing idle work instead of getting stuck.",
        details:
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        description:
          "Pi-backed plugin flows now route through Quantum more reliably, discover model support better, and keep startup prompts attached to the correct provider session.",
        details:
      ...
      },
      {
        ...
        details:
          "Quantum now preserves Cursor message identity more reliably, removes the older turn diff tree path, refines changed-file file-list rendering, fixes duplicate plan-mode icons and stale plan sidebar state, and hides inline project actions from the chat header where they created noise.",
      },
      {
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        details:
          "Quantum now discovers native editor apps and icons, caches icon assets server-side, exposes authenticated icon routes, and tightens macOS/Linux/Windows launcher handling, including Ghostty working-directory behavior and Linux desktop-entry matching.",
      },
      {
        id: "portable-skills",
      ...
      },
      {
        ...
        details:
          "Quantum now reconciles legacy migration bookkeeping before running migrations, expands migration coverage, validates workspace real-path containment, and carries terminal environment updates through shared server and web contracts.",
      },
    ],
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        details:
          "Quantum now reads provider credentials and usage data through shared server parsers, normalizes snapshots, stores cached values in SQLite, and renders reusable usage rows, progress tracks, line lists, and settings panels in the web app.",
      },
      {
    ...
    features: [
      {
        ...
        details:
          "Release tooling now validates Mac update artifacts, parses boolean environment flags consistently, and tests the resumable update downloader without the older update-feed cache layer. The README and release docs were refreshed around the current Quantum desktop flow too.",
      },
      {
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        details:
          "Claude SIGTERM from outside Quantum is treated as a benign suspend path, terminal process cleanup has stronger tests, and websocket RPC failure handling is less likely to leave the UI believing a request is still in flight.",
      },
      {
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        description:
          "Quantum can now generate and cache thread recaps, show current-state context in the chat environment, and reuse provider-backed recap generation without making the transcript harder to follow.",
      },
      {
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        description:
          "When Claude reports a missing conversation id, Quantum clears the stale resume cursor, recreates the provider session, and retries with transcript context instead of leaving the turn failed.",
      },
      {
        id: "desktop-update-manual-fallback",
        title: "Desktop updates now have a manual escape hatch",
        description:
          "If an in-app install silently fails, Quantum restarts the backend, resumes update polling, deduplicates error toasts, and points you at the exact GitHub release page for a manual download.",
      },
      {
      ...
      },
      {
        ...
        description:
          "OpenCode task child sessions and newer shell-step events now flow into Quantum's activity timeline, while generic agent task rows keep their useful prompt and result text instead of disappearing or showing wrapper noise.",
      },
      {
    ...
    features: [
      {
        ...
        description:
          "OpenCode startup, model discovery, command discovery, server connection options, and experimental WebSocket mode now flow through the same settings and runtime paths as the rest of Quantum.",
      },
      {
      ...
      },
      {
        ...
        description:
          "Fresh repair migrations reconcile older imported migration trackers that skipped Quantum's sidechat-source or pinned-thread columns, preventing startup crashes in those upgraded histories.",
      },
      {
  ...
  },
  {
    ...
    features: [
      {
        id: "quantum-home-migration",
        title: "Quantum is now the default home",
        description:
          "The app now starts from `~/.quantum`, carries the Quantum environment variables through the desktop and server runtime, and safely imports data from previous installations on first launch.",
      },
      {
    ...
    features: [
      {
        ...
        description: "Quantum now includes Claude Opus 4.8 in the Claude model picker.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        description:
          "Quantum can now launch and monitor Kilo Code sessions alongside Codex, Claude, Cursor, OpenCode, and Gemini, with health checks, settings, mentions, handoff, and model compatibility wired through the app.",
      },
      {
    ...
    features: [
      {
        ...
        description:
          "Quantum now tracks the newer OpenCode SDK session events, keeps titles fresher, and has much deeper coverage around OpenCode startup, output, and recovery flows.",
      },
      {
  ...
  },
  {
    ...
    features: [
      {
        id: "cursor-provider",
        title: "Cursor is now a first-class Quantum provider",
        description:
          "Run Cursor CLI sessions directly from Quantum with ACP-backed startup, model discovery, existing-chat resume, handoff, and provider health checks alongside Codex and OpenCode.",
      },
      {
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        description:
          "The Git actions menu can now commit current work and push it from Quantum, keeping the common release and handoff flow closer to the chat.",
      },
      {
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        description:
          "The Git menu now includes branch creation with Quantum-style names, and PR creation can recover from GitHub duplicate-PR responses by reusing the existing open pull request.",
      },
      {
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        description:
          "OpenCode todo events now flow into Quantum as active task updates, with a compact banner option for keeping current work visible without taking over the chat.",
      },
      {
      ...
      },
      {
        ...
        description:
          "OpenCode sessions now report context usage more consistently, giving Quantum better runtime visibility as conversations grow.",
      },
      {
    ...
    features: [
      {
        ...
        description:
          "Cursor is now available as a provider, with ACP sessions, model discovery, existing chats, handoff, shortcuts, and git text generation wired into Quantum.",
      },
      {
      ...
      },
      {
        ...
        description:
          "Toast notifications picked up feature-flag wiring, giving Quantum a safer way to roll notification changes forward or back.",
      },
      {
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        description:
          "The desktop app now has app-level back and forward navigation controls, making it easier to move around Quantum without losing your place.",
      },
      {
    ...
    features: [
      {
        ...
        description:
          "GPT-5.5 is now in the model picker with the right default reasoning behavior, so you can move new Codex sessions onto the latest model directly from Quantum.",
      },
      {
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        description:
          "Quantum now shows a proper splash screen while the desktop backend spins up, so launch feels intentional instead of looking briefly stalled.",
      },
      {
    ...
    features: [
      {
        ...
        description:
          "The new theme pack editor lets you tune UI colors directly in Quantum, with shared theme tokens keeping the sidebar, composer, transcript, and controls in sync.",
      },
      {
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        description:
          "If the updater never answers, Quantum now times out and recovers instead of hanging on a permanent Checking status.",
      },
    ],
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        description:
          "Point Quantum at your own Codex, Claude, or Gemini binary when your setup lives outside the default install path.",
      },
      {
