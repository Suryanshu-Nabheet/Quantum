    ...
    features: [
      {
        ...
        details:
          "The desktop bundle is now com.suryanshunabheet.quantum, and every first-party runtime identifier uses the Quantum namespace. The 0.4.2 bridge preserves renderer state during the origin change.",
      },
      {
