...
import { THREAD_GOAL_MAX_CHARS } from "@quantum/contracts";
...
describe("composerSlashCommands", () => {
  ...
  it("keeps Feedback Quantum ahead of provider-native /feedback", () => {
    const availableCommands = getAvailableComposerSlashCommands({
  ...
  it("only exposes Quantum-owned app commands for claude", () => {
