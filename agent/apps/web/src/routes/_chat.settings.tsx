...
import { PROVIDER_DISPLAY_NAMES, type ProviderKind } from "@quantum/contracts";
import { PROVIDER_DESCRIPTORS } from "@quantum/shared/providerMetadata";
import { sameAppSnapShortcut } from "@quantum/shared/appSnapShortcut";
    ...
    <div className="space-y-6">
      ...
      {isElectron ? (
        <SettingsSection title="App">
          <SettingsRow
            title="App icon"
            description="Choose the icon Quantum uses in the dock or taskbar."
            resetAction={
