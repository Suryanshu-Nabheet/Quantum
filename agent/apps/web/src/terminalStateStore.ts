...
import { type TerminalActivityState, type TerminalCliKind } from "@quantum/shared/terminalThreads";
import type { ThreadId } from "@quantum/contracts";
...
const TERMINAL_STATE_STORAGE_KEY = "quantum:terminal-state:v1";
