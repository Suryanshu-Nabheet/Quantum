...
import { resolveThreadBranchRegressionGuard } from "@quantum/shared/git";
import {
  addPinnedMessage,
  removePinnedMessage,
  setPinnedMessageDone,
  setPinnedMessageLabel,
} from "@quantum/shared/pinnedMessages";
import { isPendingInteractionResponseClaimable } from "@quantum/shared/pendingInteractions";
import {
  addThreadMarker,
  removeThreadMarker,
  setThreadMarkerDone,
  setThreadMarkerLabel,
} from "@quantum/shared/threadMarkers";
...
type ReadModelThread = import("@quantum/contracts").OrchestrationReadModel["threads"][number];
