...
export const SETTINGS_SEARCH_ENTRIES: readonly SettingsSearchEntry[] = [
  ...
  // ── Appearance ───────────────────────────────────────────────────────────────
  {
    ...
    section: "appearance",
    title: "Theme",
    keywords: "Choose how Quantum looks across the app. dark light system color",
  },
  {
    id: "appearance:app-icon",
    section: "appearance",
    title: "App icon",
    keywords: "Choose the icon Quantum uses in the dock or taskbar desktop application logo.",
    target: null,
  },
  {
    ...
    keywords: "Use the operating system interface font throughout Quantum.",
  },
  {
  ...
  // ── Keybindings ───────────────────────────────────────────────────────────────
  {
    ...
    title: "Keybindings",
    keywords:
      "Every keyboard shortcut available in Quantum, grouped by context. keybindings hotkeys key combo cmd ctrl reference",
    target: null,
  },
  ...
  // ── Worktrees ─────────────────────────────────────────────────────────────────
  {
    ...
    keywords: "Review and clean up the worktrees created by Quantum. git branch remove",
    target: null,
  },
  ...
  },
  {
    ...
    keywords: "Update installed provider tools that Quantum can safely update. upgrade cli",
  },
  {
