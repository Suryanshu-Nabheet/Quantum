...
// Depends on: @quantum/contracts tool lifecycle item types
...
import { BROWSER_TOOL_TITLES } from "@quantum/shared/browserAutomationPresentation";
...
interface QuantumMcpToolPresentation {
  readonly running: string;
  readonly completed: string;
  readonly failed: string;
}

type QuantumBrowserToolName = `quantum_${BrowserToolName}`;
const BROWSER_TOOL_NAME_SET = new Set<string>(BROWSER_TOOL_NAMES);

const QUANTUM_BROWSER_TOOL_PRESENTATIONS = Object.fromEntries(
  BROWSER_TOOL_NAMES.map((toolName) => {
    const title = BROWSER_TOOL_TITLES[toolName];
    return [`quantum_${toolName}`, { running: title, completed: title, failed: title }];
  }),
) as Record<QuantumBrowserToolName, QuantumMcpToolPresentation>;

const QUANTUM_MCP_TOOL_PRESENTATIONS = {
  quantum_context: {
    running: "Quantum is checking its context",
    completed: "Quantum checked its context",
    failed: "Quantum couldn't check its context",
  },
  quantum_capabilities: {
    running: "Quantum is checking available agents",
    completed: "Quantum checked available agents",
    failed: "Quantum couldn't check available agents",
  },
  quantum_overview: {
    running: "Quantum is gathering an overview",
    completed: "Quantum gathered an overview",
    failed: "Quantum couldn't gather an overview",
  },
  quantum_list_allowed_projects: {
    running: "Quantum is listing allowed projects",
    completed: "Quantum listed allowed projects",
    failed: "Quantum couldn't list allowed projects",
  },
  quantum_create_task: {
    running: "Quantum is creating a task",
    completed: "Quantum created a task",
    failed: "Quantum couldn't create a task",
  },
  quantum_wait_for_task: {
    running: "Quantum is waiting for a task",
    completed: "Quantum finished waiting for a task",
    failed: "Quantum couldn't wait for a task",
  },
  quantum_read_task: {
    running: "Quantum is reading a task",
    completed: "Quantum read a task",
    failed: "Quantum couldn't read a task",
  },
  quantum_list_projects: {
    running: "Quantum is listing projects",
    completed: "Quantum listed projects",
    failed: "Quantum couldn't list projects",
  },
  quantum_list_threads: {
    running: "Quantum is listing threads",
    completed: "Quantum listed threads",
    failed: "Quantum couldn't list threads",
  },
  quantum_read_thread: {
    running: "Quantum is reading a thread",
    completed: "Quantum read a thread",
    failed: "Quantum couldn't read a thread",
  },
  quantum_read_thread_activity: {
    running: "Quantum is reading thread activity",
    completed: "Quantum read thread activity",
    failed: "Quantum couldn't read thread activity",
  },
  quantum_read_thread_events: {
    running: "Quantum is reading thread events",
    completed: "Quantum read thread events",
    failed: "Quantum couldn't read thread events",
  },
  quantum_read_thread_runtime_events: {
    running: "Quantum is reading thread runtime events",
    completed: "Quantum read thread runtime events",
    failed: "Quantum couldn't read thread runtime events",
  },
  quantum_diagnose_thread: {
    running: "Quantum is diagnosing a thread",
    completed: "Quantum diagnosed a thread",
    failed: "Quantum couldn't diagnose a thread",
  },
  quantum_create_thread: {
    running: "Quantum is creating a thread",
    completed: "Quantum created a thread",
    failed: "Quantum couldn't create a thread",
  },
  quantum_create_threads: {
    running: "Quantum is creating threads",
    completed: "Quantum created threads",
    failed: "Quantum couldn't create threads",
  },
  quantum_wait_for_threads: {
    running: "Quantum is waiting for threads",
    completed: "Quantum finished waiting for threads",
    failed: "Quantum couldn't wait for threads",
  },
  quantum_send_message: {
    running: "Quantum is sending a message",
    completed: "Quantum sent a message",
    failed: "Quantum couldn't send a message",
  },
  quantum_interrupt_thread: {
    running: "Quantum is interrupting a thread",
    completed: "Quantum interrupted a thread",
    failed: "Quantum couldn't interrupt a thread",
  },
  quantum_set_thread_title: {
    running: "Quantum is renaming a thread",
    completed: "Quantum renamed a thread",
    failed: "Quantum couldn't rename a thread",
  },
  quantum_set_thread_archived: {
    running: "Quantum is updating a thread",
    completed: "Quantum updated a thread",
    failed: "Quantum couldn't update a thread",
  },
  quantum_create_automation: {
    running: "Quantum is creating an automation",
    completed: "Quantum created an automation",
    failed: "Quantum couldn't create an automation",
  },
  quantum_list_automations: {
    running: "Quantum is listing automations",
    completed: "Quantum listed automations",
    failed: "Quantum couldn't list automations",
  },
  quantum_view_automation: {
    running: "Quantum is viewing an automation",
    completed: "Quantum viewed an automation",
    failed: "Quantum couldn't view an automation",
  },
  quantum_update_automation: {
    running: "Quantum is updating an automation",
    completed: "Quantum updated an automation",
    failed: "Quantum couldn't update an automation",
  },
  quantum_update_automation_memory: {
    running: "Quantum is updating automation memory",
    completed: "Quantum updated automation memory",
    failed: "Quantum couldn't update automation memory",
  },
  quantum_report_automation_result: {
    running: "Quantum is reporting an automation result",
    completed: "Quantum reported an automation result",
    failed: "Quantum couldn't report an automation result",
  },
  quantum_cancel_automation: {
    running: "Quantum is stopping an automation",
    completed: "Quantum stopped an automation",
    failed: "Quantum couldn't stop an automation",
  },
  ...QUANTUM_BROWSER_TOOL_PRESENTATIONS,
} as const satisfies Record<string, QuantumMcpToolPresentation>;

function normalizeQuantumMcpIdentifier(value: string): string {
  return value
    .toLowerCase()
    .replace(/[^a-z0-9]+/g, "_")
    .replace(/^_+|_+$/g, "");
...
const QUANTUM_BROWSER_TOOL_NAME_BY_PRESENTATION = new Map<string, QuantumBrowserToolName>(
  BROWSER_TOOL_NAMES.map((toolName) => [
    normalizeQuantumMcpIdentifier(BROWSER_TOOL_TITLES[toolName]),
    `quantum_${toolName}`,
  ]),
);

const QUANTUM_MCP_TOOL_PRESENTATION_ENTRIES = Object.entries(QUANTUM_MCP_TOOL_PRESENTATIONS).map(
  ([toolName, presentation]) => ({
    toolName,
    presentation,
    normalizedRunning: normalizeQuantumMcpIdentifier(presentation.running),
    normalizedCompleted: normalizeQuantumMcpIdentifier(presentation.completed),
    normalizedFailed: normalizeQuantumMcpIdentifier(presentation.failed),
  }),
);

function extractQuantumMcpToolName(normalizedCandidate: string): string | null {
  if (BROWSER_TOOL_NAME_SET.has(normalizedCandidate)) {
    return `quantum_${normalizedCandidate}`;
  }
  if (normalizedCandidate.startsWith("mcp_quantum_quantum_")) {
    return normalizedCandidate.slice("mcp_quantum_".length);
  }
  if (normalizedCandidate.startsWith("mcp_quantum_")) {
    return `quantum_${normalizedCandidate.slice("mcp_quantum_".length)}`;
  }
  if (normalizedCandidate.startsWith("quantum_quantum_")) {
    return normalizedCandidate.slice("quantum_".length);
  }
  if (normalizedCandidate.startsWith("quantum_")) {
    return normalizedCandidate;
  }
  return null;
}

function resolveQuantumBrowserToolName(
  candidates: ReadonlyArray<string | null | undefined>,
): QuantumBrowserToolName | null {
  for (const candidate of candidates) {
    if (!candidate) continue;
    const normalizedCandidate = normalizeQuantumMcpIdentifier(candidate);
    const extractedToolName = extractQuantumMcpToolName(normalizedCandidate);
    const candidateToolName =
      extractedToolName ??
      QUANTUM_BROWSER_TOOL_NAME_BY_PRESENTATION.get(normalizedCandidate) ??
      normalizedCandidate;
    if (candidateToolName in QUANTUM_BROWSER_TOOL_PRESENTATIONS) {
      return candidateToolName as QuantumBrowserToolName;
    }
  }
  return null;
}

function fallbackQuantumMcpToolPresentation(toolName: string): QuantumMcpToolPresentation {
  const action =
    toolName
      .replace(/^quantum_/, "")
      .replace(/_+/g, " ")
      .trim() || "an action";
  return {
    running: `Quantum is handling ${action}`,
    completed: `Quantum handled ${action}`,
    failed: `Quantum couldn't handle ${action}`,
  };
}

function resolveQuantumMcpToolPresentation(
  candidates: ReadonlyArray<string | null | undefined>,
): QuantumMcpToolPresentation | null {
  for (const candidate of candidates) {
    if (!candidate) {
      continue;
    }
    const normalizedCandidate = normalizeQuantumMcpIdentifier(candidate);
    for (const entry of QUANTUM_MCP_TOOL_PRESENTATION_ENTRIES) {
      if (
    ...
    const toolName = extractQuantumMcpToolName(normalizedCandidate);
    const knownPresentation = toolName
      ? (QUANTUM_MCP_TOOL_PRESENTATIONS[toolName as keyof typeof QUANTUM_MCP_TOOL_PRESENTATIONS] as
          | QuantumMcpToolPresentation
          | undefined)
      : undefined;
    ...
    // word "Quantum" and normalize into a fake tool identifier; only
    // identifier-shaped candidates may take an invented fallback presentation.
    if (/\s/.test(candidate.trim())) {
      continue;
    }
    if (normalizedCandidate.startsWith("quantum_is_handling_")) {
      return fallbackQuantumMcpToolPresentation(
        `quantum_${normalizedCandidate.slice("quantum_is_handling_".length)}`,
      );
    }
    if (normalizedCandidate.startsWith("quantum_handled_")) {
      return fallbackQuantumMcpToolPresentation(
        `quantum_${normalizedCandidate.slice("quantum_handled_".length)}`,
      );
    }
    if (normalizedCandidate.startsWith("quantum_couldn_t_handle_")) {
      return fallbackQuantumMcpToolPresentation(
        `quantum_${normalizedCandidate.slice("quantum_couldn_t_handle_".length)}`,
      );
    }
    if (!toolName) {
      continue;
    }
    return fallbackQuantumMcpToolPresentation(toolName);
  }
  return null;
}

export type QuantumMcpToolStatus = "running" | "completed" | "failed" | "cancelled";

export interface QuantumMcpToolTitleInput {
  readonly toolName?: string | null | undefined;
  readonly title?: string | null | undefined;
  readonly fallbackLabel?: string | null | undefined;
  readonly status?: QuantumMcpToolStatus | undefined;
}

export function isQuantumBrowserToolCall(input: QuantumMcpToolTitleInput): boolean {
  return resolveQuantumBrowserToolName([input.toolName, input.title, input.fallbackLabel]) !== null;
}

// Every provider exposes Quantum's MCP tools differently: MCP, dynamic, and even
...
export function deriveQuantumMcpToolTitle(input: QuantumMcpToolTitleInput): string | null {
  const presentation = resolveQuantumMcpToolPresentation([
    input.toolName,
    input.title,
    input.fallbackLabel,
  ]);
  ...
  switch (input.status ?? "completed") {
    ...
    case "cancelled":
      return presentation.running.startsWith("Quantum is ")
        ? `Quantum stopped ${presentation.running.slice("Quantum is ".length)}`
        : `Cancelled ${presentation.running}`;
  }
}

export function sanitizeQuantumMcpToolPreview(input: {
  ...
  const previewTitle = deriveQuantumMcpToolTitle({ title: preview, status: input.status });
  if (
    previewTitle &&
    normalizeQuantumMcpIdentifier(previewTitle) === normalizeQuantumMcpIdentifier(input.heading)
  ) {
    return null;
  }
  return preview;
