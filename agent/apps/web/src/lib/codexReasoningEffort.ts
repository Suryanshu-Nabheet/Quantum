import type { ProviderKind, ProviderModelDescriptor } from "@quantum/contracts";
import { getModelCapabilities, hasEffortLevel, trimOrNull } from "@quantum/shared/model";
