...
describe("parseBareComposerLink", () => {
  it("returns the URL when the whole text is one bare link", () => {
    expect(parseBareComposerLink("https://github.com/example-org/sample-repo")).toBe(
...
describe("describeLinkChip", () => {
  it("shortens GitHub pull request URLs to owner/repo#number", () => {
    expect(describeLinkChip("https://github.com/example-org/sample-repo/pull/155")).toEqual({
      label: "example-org/sample-repo#155",
      isGitHub: true,
    });
  });
