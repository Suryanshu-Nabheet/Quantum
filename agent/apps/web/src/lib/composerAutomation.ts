...
import { DEFAULT_AUTOMATION_FAST_INTERVAL_MAX_ITERATIONS } from "@quantum/contracts";
import type {
  AutomationMode,
  ModelSelection,
  ProjectId,
...
import { stopWhenFromCompletionPolicy } from "@quantum/shared/automationCompletionPolicy";
