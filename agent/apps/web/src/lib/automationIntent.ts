...
// Purpose: Detects when a normal chat prompt is actually asking Quantum to create an automation.
...
import { completionPolicyFromStopWhen } from "@quantum/shared/automationCompletionPolicy";
