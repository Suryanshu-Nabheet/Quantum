...
import type { ServerConfig, ServerProviderStatus } from "@quantum/contracts";
...
function makeServerConfig(providers: readonly ServerProviderStatus[]): ServerConfig {
  return {
    ...
    studioWorkspaceRoot: "C:\\Users\\tester\\Documents\\Quantum\\Studio",
    worktreesDir: "C:\\QuantumDev\\worktrees",
    keybindingsConfigPath: "C:\\QuantumDev\\keybindings.json",
    keybindings: [],
    issues: [],
    providers,
    availableEditors: [],
...
describe("serverLocalServersQueryOptions", () => {
  ...
  it("uses visible polling while a Quantum-owned project run is active", () => {
    const options = sidebarLocalServersQueryOptions({
