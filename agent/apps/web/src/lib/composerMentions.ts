...
import type { ProviderMentionReference, ProviderSkillReference } from "@quantum/contracts";
import { isThreadMentionPath, threadIdFromThreadMentionPath } from "@quantum/shared/threadMentions";
