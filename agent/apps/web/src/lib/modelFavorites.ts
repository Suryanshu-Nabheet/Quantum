...
export const FAVORITE_MODEL_STORAGE_KEYS = {
  cursor: "quantum:cursor-favourite-models:v1",
  kilo: "quantum:kilo-favourite-models:v1",
  opencode: "quantum:opencode-favourite-models:v1",
  pi: "quantum:pi-favourite-models:v1",
} as const;
