...
import type { ProviderKind, ServerProviderStatus, ServerSettings } from "@quantum/contracts";
...
describe("getVisibleProviderUpdateStatuses", () => {
  it("excludes providers hidden from Quantum so unchecked providers do not nag", () => {
...
describe("shouldPromptProviderUpdate", () => {
  // Cursor and Antigravity self-update, so Quantum has no registry to read a latest
  ...
  it("keeps prompting for providers Quantum can prove are behind", () => {
