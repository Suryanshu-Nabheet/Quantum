...
describe("workspacePathsStore", () => {
  ...
  it("keeps chat workspace root while server config is still loading", async () => {
    ...
    useWorkspacePathsStore.getState().setChatWorkspaceRoot("/Users/tester/Documents/Quantum");
    ...
    expect(useWorkspacePathsStore.getState().chatWorkspaceRoot).toBe(
      "/Users/tester/Documents/Quantum",
    );
  });
  ...
  it("keeps studio workspace root while server config is still loading", async () => {
    ...
    useWorkspacePathsStore
      .getState()
      .setStudioWorkspaceRoot("/Users/tester/Documents/Quantum/Studio");
    ...
    expect(useWorkspacePathsStore.getState().studioWorkspaceRoot).toBe(
      "/Users/tester/Documents/Quantum/Studio",
    );
  });
  ...
  it("migrates cached paths without retaining legacy workspace pages", async () => {
    ...
    localStorage.setItem(
      "quantum:workspace-pages:v2",
      JSON.stringify({
        state: {
          homeDir: "/Users/legacy",
          chatWorkspaceRoot: "/Users/legacy/Documents/Quantum",
    ...
    expect(useWorkspacePathsStore.getState().chatWorkspaceRoot).toBe(
      "/Users/legacy/Documents/Quantum",
    );
    ...
    expect(localStorage.getItem("quantum:workspace-pages:v2")).toBeNull();
    expect(localStorage.getItem("quantum:workspace-paths:v1")).not.toBeNull();
  });
});
