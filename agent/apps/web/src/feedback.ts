...
export const FEEDBACK_CATEGORIES = [
  ...
  { value: "performance", label: "Performance", lead: "Quantum felt slow" },
...
export function formatFeedbackSummary(input: {
  ...
  return [`${lead} in Quantum ${diagnostics.appVersion}${usageContext}.`, "", ...detailLines].join(
    "\n",
  );
}
