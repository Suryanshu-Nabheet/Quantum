...
// A provider whose latest version Quantum cannot look up (self-updating CLIs such as
...
// Header affordance: reserved for providers Quantum can actually assert are outdated.
