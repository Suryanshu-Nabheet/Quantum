...
# Steps
1. Find setup instructions in README.md, CONTRIBUTING.md, and scripts/README.md at the root of the repository. Prefer running `./scripts/setup.sh` (macOS/Linux) or `scripts\setup.bat` (Windows) for end-to-end setup when on a supported platform. Fetch any other documentation they recommend.
