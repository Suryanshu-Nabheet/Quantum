...
This project and everyone participating in it is governed by the [Quantum Code of Conduct](CODE_OF_CONDUCT.md). By participating, you are expected to uphold this code.
...
To build Quantum, please follow the command found in the section [`Build Scripts`](./docs/howto-build.md#build-scripts).
...
- first, you need to build Quantum
