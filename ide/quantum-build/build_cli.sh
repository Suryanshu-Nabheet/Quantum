...
export VSCODE_CLI_UPDATE_ENDPOINT="https://github.com/Suryanshu-Nabheet/Quantum"

if [[ "${VSCODE_QUALITY}" == "insider" ]]; then
  export VSCODE_CLI_DOWNLOAD_ENDPOINT="https://github.com/Suryanshu-Nabheet/Quantum/releases"
else
  export VSCODE_CLI_DOWNLOAD_ENDPOINT="https://github.com/Suryanshu-Nabheet/Quantum"
fi
