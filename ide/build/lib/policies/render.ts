...
<policyDefinitions revision="1.1" schemaVersion="1.0">
	<policyNamespaces>
		<target prefix="${regKey}" namespace="Suryanshu-Nabheet.Policies.${regKey}" />
	</policyNamespaces>
...
export function renderProfileManifest(appName: string, bundleIdentifier: string, _versions: string[], _categories: Category[], policies: Policy[], translations?: LanguageTranslations) {
	...
	const requiredPayloadFields = `
		...
		<dict>
			<key>pfm_default</key>
			<string>Suryanshu-Nabheet</string>
			<key>pfm_name</key>
...
<dict>
    <key>pfm_app_url</key>
    <string>https://github.com/Suryanshu-Nabheet/Quantum</string>
...
${policyEntries}
		...
		<string>This profile manages ${appName}. For more information see https://github.com/Suryanshu-Nabheet/Quantum</string>
		<key>PayloadDisplayName</key>
		<string>${appName}</string>
		<key>PayloadIdentifier</key>
		<string>${bundleIdentifier}</string>
