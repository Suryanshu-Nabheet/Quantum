...
const minifyVSCodeWebTask = task.define('minify-vscode-web-OLD', task.series(
	...
	optimize.minifyTask('out-vscode-web', `https://github.com/Suryanshu-Nabheet/Quantum/download/${product.quality}-${commit}/core`)
));
gulp.task(minifyVSCodeWebTask);

// esbuild-based tasks (new)
const sourceMappingURLBase = `https://github.com/Suryanshu-Nabheet/Quantum/download/${product.quality}-${commit}`;
