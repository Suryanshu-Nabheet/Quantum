...
export default tseslint.config(
	...
	// Disallow 'in' operator except in type predicates
	{
		...
		ignores: [
			...
			'src/vs/workbench/contrib/onboarding/browser/onboarding.contribution.ts',
			...
			'local/code-import-patterns': [
				...
				},
				{
					...
					'restrictions': [
						...
						'vs/workbench/contrib/agent/workbench/**',
						'vs/workbench/contrib/agent/shared/**',
				...
				{
					'target': 'src/vs/workbench/contrib/agent/workbench/**',
					'restrictions': [
						'vs/base/~',
						'vs/base/parts/*/~',
						'vs/platform/*/~',
						...
						'vs/workbench/contrib/agent/shared/**',
						'vs/workbench/contrib/chat/common/**',
						'vs/workbench/contrib/browserView/**',
					]
				},
				{
