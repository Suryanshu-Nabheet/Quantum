...
import { isQuantumOnboardingEnabled } from '../../onboarding/common/onboardingTypes.js';
...
registerAction2(class extends Action2 {
	constructor() {
		super({
			...
			metadata: {
				description: localize2('minWelcomeDescription', 'Opens a Walkthrough to help you get started in Quantum.')
			}
		});
	}
	...
	public run(
		...
		if (!walkthroughID && isQuantumOnboardingEnabled(configurationService)) {
			commandService.executeCommand('workbench.action.showWelcome');
			return;
		}
...
configurationRegistry.registerConfiguration({
	...
	properties: {
		...
		'workbench.welcomePage.extraAnnouncements': {
			...
			type: 'boolean',
			default: true,
			description: localize('workbench.welcomePage.extraAnnouncements', "When enabled, the get started page loads additional announcements from Quantum's repository."),
		...
		'workbench.startupEditor': {
			...
			'enumDescriptions': [
				...
				localize({ comment: ['This is the description for a setting. Values surrounded by single quotes are not to be translated.'], key: 'workbench.startupEditor.welcomePage' }, "Open the Welcome page, with content to aid in getting started with Quantum and extensions."),
				...
				localize({ comment: ['This is the description for a setting. Values surrounded by single quotes are not to be translated.'], key: 'workbench.startupEditor.agentSessionsWelcomePage' }, "Open the Agent Sessions Welcome page. Will override the workbench Agent visibility settings."),
			],
			'default': 'none',
		...
		'workbench.welcomePage.experimentalOnboarding': {
			...
			default: true,
			tags: ['experimental'],
			description: localize('workbench.welcomePage.experimentalOnboarding', "When enabled, show Quantum onboarding instead of the classic VS Code welcome page and walkthroughs."),
			experiment: {
				mode: 'auto'
			}
		}
