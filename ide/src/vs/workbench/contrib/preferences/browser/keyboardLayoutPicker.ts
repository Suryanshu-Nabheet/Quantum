...
const DEFAULT_CONTENT: string = [
	`// ${nls.localize('displayLanguage', 'Defines the keyboard layout used in Quantum in the browser environment.')}`,
	`// ${nls.localize('doc', 'Open Quantum and run "Developer: Inspect Key Mappings (JSON)" from Command Palette.')}`,
	``,
