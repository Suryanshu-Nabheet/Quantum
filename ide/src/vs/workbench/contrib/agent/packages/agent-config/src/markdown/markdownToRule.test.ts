import { SourceReference } from "../browser.js";
import { getRuleName, markdownToRule } from "./markdownToRule.js";

describe("markdownToRule", () => {
  // Use a mock SourceReference for testing
  const mockId: SourceReference = {
    uriType: "file",
...
This is a test rule.`;
    ...
    it("should not prepend when inside .agent", () => {
      const content = `---
globs: ".git"
name: glob pattern testing
---
  ...
  This is a test rule.`;
      ...
      const result = markdownToRule(
        ...
        {
          uriType: "file",
          fileUri: "file:///Documents/myproject/.agent/rules/rule1.md",
        },
        "/Documents/myproject/.agent/",
      );
...
This is a test rule.`;
  ...
  it("should use sourceReferenceToDisplayName if no heading or frontmatter name", () => {
    const content = `---
globs: "**/test/**/*.kt"
---
...
This is a test rule.`;
  ...
  it("should use sourceReferenceToDisplayName if no heading or frontmatter name (no heading)", () => {
    const content = `---
globs: "**/test/**/*.kt"
---
