...
export class AnthropicApi implements BaseLlmApi {
  ...
  async completionNonStream(
    ...
    throw new Error("Anthropic does not support legacy text completions.");
  }
  ...
  async *fimStream(
    ...
    throw new Error("Anthropic does not support fill-in-the-middle completions.");
  }
  ...
  async rerank(body: RerankCreateParams): Promise<CreateRerankResponse> {
    throw new Error("Anthropic does not support reranking.");
  }

  list(): Promise<OpenAI.Models.Model[]> {
    throw new Error("Anthropic does not support model listing via this adapter.");
  }
}
