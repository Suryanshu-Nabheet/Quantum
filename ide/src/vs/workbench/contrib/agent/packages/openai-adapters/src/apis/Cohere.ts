...
export class CohereApi implements BaseLlmApi {
  ...
  completionNonStream(
    ...
    throw new Error("Cohere does not support legacy text completions.");
  }
  completionStream(
  ...
  fimStream(
    ...
    throw new Error("Cohere does not support fill-in-the-middle completions.");
  }
  ...
  list(): Promise<Model[]> {
    throw new Error("Cohere does not support listing models via this adapter.");
  }
}
