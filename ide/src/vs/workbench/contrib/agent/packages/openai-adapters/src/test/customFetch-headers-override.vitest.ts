 ...
 */
describe("customFetch - header override logic", () => {
  ...
  it("should handle requestOptions with both token headers", () => {
    const result = customFetch({
      headers: {
 ...
 * mocking the entire fetch stack (fetch package) which is
