...
export class GeminiApi implements BaseLlmApi {
  ...
  completionNonStream(
    ...
    throw new Error("Gemini does not support legacy text completions.");
  }
  completionStream(
  ...
  fimStream(
    ...
    throw new Error("Gemini does not support fill-in-the-middle completions.");
  }
  ...
  list(): Promise<Model[]> {
    throw new Error("Gemini does not support listing models via this adapter.");
  }
}
