...
describe("shouldIgnore", () => {
  ...
  test("should return true if a folder is ignored by .agentignore", async () => {
    addToTestDir([
      ["ignored-folder/file.txt", "content"],
      [".agentignore", "ignored-folder/"],
    ]);
  ...
  test("should return true if a .agentignore override ignores file", async () => {
    addToTestDir([
      ["override-file.txt", "content"],
      [".gitignore", "override-file.txt"],
      [".agentignore", "!override-file.txt"],
    ]);
    const result = await shouldIgnore(
  ...
  test("should return true for deeply nested file ignored by ignore files at multiple levels", async () => {
    addToTestDir([
      ...
      ["level1/level2/.agentignore", "level3/"],
    ]);
    const result = await shouldIgnore(
