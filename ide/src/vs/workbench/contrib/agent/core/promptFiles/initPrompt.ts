...
If any of these tools are unavailable, inform the user that they need to activate them and enable Agent mode before proceeding.
...
Create a comprehensive ${initFilename} file at the workspace root with the following sections:
...
## Step 4: Finalize
After creating ${initFilename} at the workspace root, provide a summary of what you've created and remind the user to:
1. Review and edit the file as needed
2. Commit it to their repository to share with their team
3. Explain that Agent will automatically load this file into context when working with the project
