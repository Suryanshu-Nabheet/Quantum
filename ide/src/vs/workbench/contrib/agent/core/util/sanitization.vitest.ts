...
describe("validateGitHubRepoUrl", () => {
  it("should accept valid repository names", () => {
    expect(validateGitHubRepoUrl("Suryanshu-Nabheet/agent")).toBe(true);
...
describe("sanitizeShellArgument - integration tests", () => {
  ...
  it("should handle git stash message use case safely", () => {
    ...
    const stashMessage = `Agent: Stashed before opening agent ${agentId}`;
    ...
    expect(result).toContain("Agent: Stashed before opening agent");
