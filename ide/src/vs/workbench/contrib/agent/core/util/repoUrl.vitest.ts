...
describe("normalizeRepoUrl", () => {
  ...
  describe("case normalization", () => {
    ...
    it("should handle mixed case in shorthand format", () => {
      expect(normalizeRepoUrl("Suryanshu-Nabheet/Agent")).toBe(
        "https://github.com/suryanshu-nabheet/agent",
      );
    });
  });
  ...
  describe("real-world examples", () => {
    it("should normalize repository from SSH", () => {
      expect(
        normalizeRepoUrl("git@github.com:Suryanshu-Nabheet/agent.git"),
      ).toBe("https://github.com/suryanshu-nabheet/agent");
    });

    it("should normalize repository from shorthand", () => {
      expect(normalizeRepoUrl("Suryanshu-Nabheet/agent")).toBe(
        "https://github.com/suryanshu-nabheet/agent",
      );
    });

    it("should normalize repository from HTTPS", () => {
      expect(
        normalizeRepoUrl("https://github.com/Suryanshu-Nabheet/agent.git"),
      ).toBe("https://github.com/suryanshu-nabheet/agent");
    });

    it("should match repositories regardless of input format", () => {
      const formats = [
        "git@github.com:Suryanshu-Nabheet/agent.git",
        "Suryanshu-Nabheet/agent",
        "https://github.com/Suryanshu-Nabheet/agent",
        "https://github.com/Suryanshu-Nabheet/agent.git",
        "ssh://git@github.com/Suryanshu-Nabheet/agent.git",
        "Suryanshu-Nabheet/Agent",
      ];

      const expected = "https://github.com/suryanshu-nabheet/agent";
