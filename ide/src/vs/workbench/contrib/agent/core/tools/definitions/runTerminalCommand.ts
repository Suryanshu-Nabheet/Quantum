...
const RUN_COMMAND_NOTES = `The shell is not stateful and will not remember any previous commands.\
      ...
      IMPORTANT: Prefer built-in tools over shell when possible — use ${BuiltInToolNames.LSTool} instead of ls, ${BuiltInToolNames.ReadFile} instead of cat/head/tail, and ${BuiltInToolNames.GrepSearch} instead of grep/rg.\
