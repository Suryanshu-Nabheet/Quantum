...
export default MyComponent;`;
  ...
  describe("Edge cases", () => {
    ...
    it("should handle unicode characters", () => {
      const fileContent = "const label = 'café 日本語';";
      const searchContent = "café 日本語";
      const result = findSearchMatch(fileContent, searchContent);
    ...
    it("should fuzzy-match multi-line blocks with minor typos", () => {
      const fileContent = `function greet() {
  return "hello";
}`;
      const searchContent = `function greet() {
  return "helo";
}`;
      const result = findSearchMatch(fileContent, searchContent);
