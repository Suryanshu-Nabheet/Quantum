        ...
        <div className="mt-5">
          <form onSubmit={handleSubmit} className="flex flex-col gap-1">
            ...
            <div className="flex flex-col gap-2">
              <textarea
                className="border-[color:var(--vscode-sideBar-border,rgba(128,128,128,0.22))] bg-input text-input-foreground placeholder:text-input-placeholder focus:border-border-focus box-border w-full resize-none rounded border p-2 text-xs focus:outline-none"
