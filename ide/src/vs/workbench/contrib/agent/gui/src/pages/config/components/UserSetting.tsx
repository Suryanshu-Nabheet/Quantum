  ...
  const renderControl = () => {
    switch (props.type) {
      ...
      case "input":
          ...
          return (
            ...
            >
              <div className="flex items-center gap-2">
                <div
                  className={`border-[color:var(--vscode-sideBar-border,rgba(128,128,128,0.22))] bg-vsc-input-background focus-within:border-border-focus focus-within:ring-border-focus flex w-full flex-row overflow-hidden rounded-md border border-solid focus-within:ring-1 ${
                    props.isDirty
                      ? !props.isValid
                  ...
                  <div className="flex flex-row items-center gap-1">
                    <ToolTip content="Save">
                      <button
                        type="submit"
                        aria-label="Save"
                        className="flex cursor-pointer items-center border-none bg-transparent p-0 outline-none focus-visible:ring-1 focus-visible:ring-border-focus"
                      >
                        <CheckIcon className="text-success h-4 w-4 hover:opacity-80" />
                      </button>
                    </ToolTip>
                    <ToolTip content="Cancel">
                      <button
                        ...
                        className="flex cursor-pointer items-center border-none bg-transparent p-0 outline-none focus-visible:ring-1 focus-visible:ring-border-focus"
                      >
                        <XMarkIcon className="text-error h-4 w-4 hover:opacity-80" />
                      </button>
                    </ToolTip>
                  </div>
                )}
        ...
        return (
          <div
            className={`border-[color:var(--vscode-sideBar-border,rgba(128,128,128,0.22))] bg-vsc-input-background focus-within:border-border-focus focus-within:ring-border-focus flex w-full flex-row overflow-hidden rounded-md border border-solid focus-within:ring-1 ${disabled ? "cursor-not-allowed opacity-50" : ""}`}
          >
            <input
              type="text"
              value={props.value}
