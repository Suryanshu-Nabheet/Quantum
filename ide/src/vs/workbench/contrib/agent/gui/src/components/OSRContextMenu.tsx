...
const OSRContextMenu = () => {
  ...
  return (
    <div
      className="bg-vsc-editor-background absolute flex flex-col gap-1.5 overflow-hidden rounded-md border border-solid border-border px-3 py-1.5"
      style={{
        ...position,
        zIndex: 9999,
      }}
      ...
      {canPaste && (
        <div
          ...
          onClick={async (e) => {
            ...
            const clipboardText =
              response.status === "success" ? response.content.text : "";
            if (clipboardText) {
