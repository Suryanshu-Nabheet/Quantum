...
export const sessionSlice = createSlice({
  ...
  reducers: {
    ...
    setAllSessionMetadata: (
      ...
      {
        payload,
      }: PayloadAction<BaseSessionMetadata[]>,
    ) => {
    ...
    clearNewestToolbarPreviewForInput: (
      state,
      { payload }: PayloadAction<{ inputId: string }>,
    ) => {
      delete state.newestToolbarPreviewForInput[payload.inputId];
    },
