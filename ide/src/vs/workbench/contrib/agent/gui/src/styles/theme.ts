...
export const THEME_COLORS = {
  ...
  "input-border": {
    // Prefer soft sidebar hairline over --vscode-input-border, which many
    // dark themes resolve to a near-white stroke that frays at border-radius.
    vars: [
      "--input-border-preferred",
      "--vscode-sideBar-border",
      "--vscode-panel-border",
      "--vscode-input-border",
    ],
