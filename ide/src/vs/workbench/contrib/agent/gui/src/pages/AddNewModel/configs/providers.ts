...
export const providers: Partial<Record<string, ProviderInfo>> = {
  cometapi: {
    ...
    longDescription:
      "Unified Access to Leading AI Models. Visit [cometapi.com](https://www.cometapi.com/) for more details.",
    icon: "cometapi.png",
  ...
  openrouter: {
    ...
    provider: "openrouter",
    description:
      "OpenRouter provides access to a variety of LLMs including public-weight and proprietary models.",
  ...
  moonshot: {
    ...
    longDescription: `Obtain an API key from the Moonshot developer portal.`,
    icon: "moonshot.png",
    tags: [ModelProviderTags.RequiresApiKey],
    refPage: "moonshot",
  ...
  "function-network": {
    ...
    description:
      "Run public-weight models on Function Network. Private, Affordable User-Owned AI",
    icon: "function-network.png",
    longDescription: `Function Network is a private, affordable user-owned AI platform that allows you to run public-weight models. Experience bleeding-edge Generative AI models with limitless scalability, all powered by our distributed inference network.`,
  ...
  azure: {
    ...
    longDescription: `Obtain credentials from the Azure OpenAI portal.
...
Select the \`GPT-4o\` model below to complete your provider configuration, but note that this will not affect the specific model you need to select when creating your Azure deployment.`,
    ...
    collectInputFor: [
      {
        inputType: "text",
        key: "apiKey",
        label: "API Key (optional, for Ollama cloud)",
        placeholder: "Or set OLLAMA_API_KEY in your environment",
        required: false,
      },
      ...completionParamsInputsConfigs,
  ...
  groq: {
    ...
    icon: "groq.png",
    description:
      "Groq is the fastest LLM provider by a wide margin, using 'LPUs' to serve public-weight models at blazing speed.",
    longDescription:
  ...
  deepseek: {
    ...
    icon: "deepseek.png",
    description:
      "DeepSeek provides cheap inference of its DeepSeek Coder v2 and other impressive public-weight models.",
    longDescription:
  ...
  together: {
    ...
    refPage: "together",
    description:
      "Use the TogetherAI API for extremely fast streaming of public-weight models",
    icon: "together.png",
    longDescription: `Together is a hosted service that provides extremely fast streaming of public-weight language models. To get started with Together:\n1. Obtain an API key from [here](https://together.ai)\n2. Paste below\n3. Select a model preset`,
    tags: [ModelProviderTags.RequiresApiKey, ModelProviderTags.OpenSource],
    params: {
      apiKey: "",
    },
  ...
  ncompass: {
    ...
    refPage: "ncompass",
    description:
      "Use the nCompass API for extremely fast streaming of public-weight models",
    icon: "ncompass.png",
    longDescription: `nCompass is an extremely fast inference engine for public-weight language models. To get started, obtain an API key from [their console](https://app.ncompass.tech/api-settings).`,
    tags: [ModelProviderTags.RequiresApiKey, ModelProviderTags.OpenSource],
    params: {
      apiKey: "",
    },
  ...
  novita: {
    ...
    refPage: "novita",
    description:
      "Use Novita AI API for extremely fast streaming of public-weight models",
    icon: "novita.png",
  ...
  lemonade: {
    ...
    longDescription:
      "Lemonade provides optimized local LLM inference with support for AMD NPU, GPU, and CPU acceleration. Visit [lemonade-server.ai](https://lemonade-server.ai/) for installation and setup instructions. Once the Lemonade server is running, you can begin using Agent with your local models.",
    icon: "lemonade.png",
    tags: [ModelProviderTags.Local, ModelProviderTags.OpenSource],
    params: {
  ...
  llamafile: {
    ...
    icon: "llamafile.png",
    description:
      "llamafiles are a self-contained binary to run a local LLM",
...
After it's up and running, you can start using Agent.`,
    icon: "llamacpp.png",
    tags: [ModelProviderTags.Local, ModelProviderTags.OpenSource],
    packages: openSourceModels,
    collectInputFor: [...completionParamsInputsConfigs],
...
- [llama-cpp-python server](https://github.com/ggerganov/llama.cpp/tree/master/examples/server)
...
To get started, [register](https://dataplatform.cloud.ibm.com/registration/stepone?context=wx) on watsonx SaaS, create your first project and setup an [API key](https://www.ibm.com/docs/en/mas-cd/continuous-delivery?topic=cli-creating-your-cloud-api-key).`,
  ...
  sambanova: {
    ...
    icon: "sambanova.png",
    longDescription: `The SambaNova Cloud is a cloud platform for running large public-weight AI models with world record performance and zero data retention. You can sign up [here](http://cloud.sambanova.ai).`,
    tags: [ModelProviderTags.RequiresApiKey, ModelProviderTags.OpenSource],
    params: {
      apiKey: "",
    },
  ...
  nebius: {
    ...
    provider: "nebius",
    refPage: "nebius",
    description: "Use the Nebius API to run public-weight models",
  ...
  siliconflow: {
    ...
    description: "SiliconFlow provides cheap public-weight models.",
    longDescription:
