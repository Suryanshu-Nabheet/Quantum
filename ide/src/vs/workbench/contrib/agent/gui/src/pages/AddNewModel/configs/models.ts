...
export const models: { [key: string]: ModelPackage } = {
  ...
  deepseekReasonerApi: {
    ...
    description:
      "A public-weight reasoning model which generates a chain of thought to enhance the accuracy of its responses.",
    params: {
      title: "DeepSeek Reasoner",
  ...
  deepseekCoder2Lite: {
    ...
    description:
      "DeepSeek-Coder-V2-Lite-Instruct is a public-weight code language model that supports 338 programming languages and offers a context length of up to 128,000 tokens.",
    params: {
  ...
  Hunyuan_a52b: {
    title: "Hunyuan A52B",
    description:
      "Hunyuan-Large is the industry's largest public-weight Transformer architecture MoE model.",
    params: {
      title: "Hunyuan A52B",
