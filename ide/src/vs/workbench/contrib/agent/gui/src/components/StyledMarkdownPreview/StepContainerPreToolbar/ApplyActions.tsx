...
export function ApplyActions(props: ApplyActionsProps) {
  ...
  switch (props.applyState ? props.applyState.status : null) {
    ...
    case "done":
      return (
        <div className="bg-badge text-badge-foreground flex min-h-5 select-none items-center rounded sm:gap-1 md:px-1.5">
          <span className="flex items-center text-center text-xs font-medium leading-none max-md:hidden">
