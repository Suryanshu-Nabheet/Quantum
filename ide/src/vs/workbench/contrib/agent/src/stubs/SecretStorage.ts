...
import { EXTENSION_ID } from "../util/extensionMeta";

const ENCRYPTION_KEY_NAME = EXTENSION_ID;
 ...
 * so we store the encryption key in vscode.SecretStorage, and handle the encrypted data ourselves
 */
