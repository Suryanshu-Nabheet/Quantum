	...
	constructor() {
		super({
			...
			menu: [
				...
				{ id: MenuId.TitleBarNavigation, order: 2, when: ContextKeyExpr.has('config.workbench.navigationControl.enabled') }
			]
		});
	}
	...
	constructor() {
		super({
			...
			menu: [
				...
				{ id: MenuId.TitleBarNavigation, order: 1, when: ContextKeyExpr.has('config.workbench.navigationControl.enabled') }
			]
		});
	}
