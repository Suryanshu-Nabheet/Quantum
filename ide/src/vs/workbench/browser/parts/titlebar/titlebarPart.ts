...
export class BrowserTitlebarPart extends Part implements ITitlebarPart {
	...
	private leftNavigationToolBarElement: HTMLElement | undefined;
	private readonly leftNavigationToolBarDisposable = this._register(new DisposableStore());
	...
	protected onConfigurationChanged(event: IConfigurationChangeEvent): void {
		...
		if (hasCustomTitlebar(this.configurationService, this.titleBarStyle) && this.actionToolBar) {
			...
			const affectsActivityControl = event.affectsConfiguration(LayoutSettings.ACTIVITY_BAR_LOCATION) || event.affectsConfiguration(LayoutSettings.ACTIVITY_BAR_ORIENTATION);
	...
	protected override createContentArea(parent: HTMLElement): HTMLElement {
		...
		// Left Navigation Toolbar (Go Back / Go Forward)
		if (hasCustomTitlebar(this.configurationService, this.titleBarStyle)) {
			this.leftNavigationToolBarElement = append(this.leftContent, $('div.left-navigation-toolbar-container'));
			this.leftNavigationToolBarDisposable.add(this.instantiationService.createInstance(MenuWorkbenchToolBar, this.leftNavigationToolBarElement, MenuId.TitleBarNavigation, {
		...
		if (hasCustomTitlebar(this.configurationService, this.titleBarStyle)) {
			this.centerAdjacentToolBarElement = append(this.rightContent, $('div.center-adjacent-toolbar-container'));
			this.centerAdjacentToolBarDisposable.add(this.instantiationService.createInstance(MenuWorkbenchToolBar, this.centerAdjacentToolBarElement, MenuId.TitleBarAdjacentCenter, {
				contextMenu: MenuId.TitleBarContext,
				hiddenItemStrategy: HiddenItemStrategy.NoHide,
				toolbarOptions: {
					primaryGroup: () => true,
