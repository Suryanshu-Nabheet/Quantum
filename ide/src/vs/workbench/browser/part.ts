...
import { Dimension, size, IDimension, getActiveDocument, prepend, IDomPosition, hide, show } from '../../base/browser/dom.js';
...
export abstract class Part<MementoType extends object = object> extends Component<MementoType> implements ISerializableView {
	...
	protected setTitleVisibility(visible: boolean): void {
		if (!this.options.hasTitle || !this.titleArea) {
			return;
		}
