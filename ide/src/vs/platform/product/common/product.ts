...
// _VSCODE environment
	...
	try {
		// Deep-merge helper for optional user product overrides (intentionally loosely typed).
		/* eslint-disable @typescript-eslint/no-explicit-any, local/code-no-any-casts */
		...
		/* eslint-enable @typescript-eslint/no-explicit-any, local/code-no-any-casts */
...
// Web environment or unknown
	...
	if (Object.keys(product).length === 0) {
		Object.assign(product, {
			...
			dataFolderName: '.quantum',
			urlProtocol: 'quantum',
			reportIssueUrl: 'https://github.com/Suryanshu-Nabheet/Quantum/issues/new',
			licenseName: 'MIT',
			licenseUrl: 'https://github.com/Suryanshu-Nabheet/Quantum/blob/main/LICENSE.txt',
			serverLicenseUrl: 'https://github.com/Suryanshu-Nabheet/Quantum/blob/main/LICENSE.txt',
			defaultChatAgent: {
