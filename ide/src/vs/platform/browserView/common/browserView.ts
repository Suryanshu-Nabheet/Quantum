...
export interface IBrowserViewTheme {
	...
	/**
	 * Visible accent used by the element-picker overlay (hover box / drag box).
	 * Must not be transparent — Quantum themes intentionally clear `focusBorder`.
	 */
	readonly pickerHighlight?: string;
