...
|---------|-----------|-------|
| Sidebar / Aux Bar / Panel toggle | Enabled | Fixed positions (sidebar: left, panel: bottom) |
| Maximize Panel | Enabled | Excludes titlebar |
| Resize Parts | Enabled | Via grid sash or programmatic API |
| Zen Mode / Centered Layout / Menu Bar Toggle | Disabled No-op | — |
| Maximize Auxiliary Bar | Disabled No-op | — |
...
**Initial part visibility:** Sidebar Enabled, Chat Bar Enabled, Auxiliary Bar Enabled, Editor Disabled, Panel Disabled
