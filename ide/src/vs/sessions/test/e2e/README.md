...
> Scenario: Repository picker opens when submitting without a repo
  Enabled   step 1: Click button "Cloud"
  Enabled   step 2: Type "build the project" in the chat input
  Enabled   step 3: Press Enter to submit
  Enabled   step 4: Verify the repository picker dropdown is visible

> Scenario: Switching to Cloud target disables the Add Run Action button
  Enabled   step 1: Click button "Cloud"
  Enabled   step 2: Click button "Local"
