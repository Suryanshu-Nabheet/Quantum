...
**Cannot import from:**
- Disabled `vs/sessions/contrib/*` — no contrib dependencies
- Disabled `vs/sessions/contrib/providers/*` — no provider dependencies
...
**Cannot import from:**
- Disabled `vs/sessions/contrib/providers/*/~` — **providers are isolated from non-provider contribs**
