...
export abstract class $state {
	...
	/**
	 * Quantum `problems.visibility` setting value.
	 */
	static quantumGlobalProblemsEnabled = true;
	/**
	 * Quantum `files.autoSave` setting value.
	 */
	static quantumAutosaveEnabled = false;
	/**
	...
	/**
	 * `true` when use specified anything inide of `quantumErrorLens.transmute` setting.
	 */
...
export function activate(context: ExtensionContext): void {
	...
	function updateConfigAndEverything(): void {
		...
		$state.quantumGlobalProblemsEnabled = workspace.getConfiguration('problems').get<boolean>('visibility') ?? true;
		$state.quantumAutosaveEnabled = workspace.getConfiguration('files').get<string>('autoSave') === 'afterDelay';
		disposeEverything();
		if ($config.enabled) {
