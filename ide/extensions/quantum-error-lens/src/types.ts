...
interface ExtensionConfigType {
	...
	enabled: boolean;
	/**
	 * When enabled - extension will take into account global Quantum setting `#problems.visibility#`.
	 */
	...
	/**
	 * Replaces `$severity` variable in `#quantumErrorLens.messageTemplate#`.
	 */
	severityText: string[];
	/**
	...
	/**
	 * Which problem to select when running `quantumErrorLens.selectProblem` command.
	 */
	...
	/**
	 * See `#quantumErrorLens.messageTemplate#`.
	 */
	...
	/**
	 * When `#quantumErrorLens.onSave#` enabled - extension still draws decorations when active/visible editors change.
	 */
	...
	/**
	 * Symbol to replace linebreaks. Requires enabling `#quantumErrorLens.removeLinebreaks#`.
	 */
	...
	/**
	 * When enabled and `#quantumErrorLens.followCursor#` setting is not `allLines`, then gutter icons would be rendered for all problems.
	...
	/**
	 * Pick emoji symbol for gutter icon when `#quantumErrorLens.gutterIconSet#` is `emoji`.
	 */
	gutterEmoji: {
		error: string;
		warning: string;
	...
	ignoreDirty: boolean;
	/**
	 * Controls whether to show the Quantum Error Lens as a Code Lens above the code.
	 */
	...
	/**
	 * Controls what do on clicking the `#quantumErrorLens.codeLensEnabled#`
	 */
...
export const enum Constants {
	 ...
	 */
	ExtensionId = 'Suryanshu-Nabheet.quantum-error-lens',
	/**
	 * Prefix used for all settings of this extension.
	 */
	SettingsPrefix = 'quantumErrorLens',
	/**
	 * Command id of Quantum command to show problems view.
	 */
	OpenProblemsViewCommandId = 'workbench.actions.view.problems',
	/**
	 * Command id of Quantum show quick fix menu in editor.
	 */
	QuickFixCommandId = 'editor.action.quickFix',
	/**
	 * Command id of Quantum command to focus active editor group.
	 */
	FocusActiveEditorCommandId = 'workbench.action.focusActiveEditorGroup',
	/**
	 * Command id of Quantum command to open next problem marker.
	 */
