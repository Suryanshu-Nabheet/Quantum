...
export function setDecorationStyle(context: ExtensionContext): void {
	...
	let errorBackground: ThemeColor | undefined = new ThemeColor('quantumErrorLens.errorBackground');
	let errorBackgroundLight: ThemeColor | undefined = new ThemeColor('quantumErrorLens.errorBackgroundLight');
	const errorForeground = new ThemeColor('quantumErrorLens.errorForeground');
	const errorForegroundLight = new ThemeColor('quantumErrorLens.errorForegroundLight');
	let errorMessageBackground: ThemeColor | undefined = new ThemeColor('quantumErrorLens.errorMessageBackground');

	let warningBackground: ThemeColor | undefined = new ThemeColor('quantumErrorLens.warningBackground');
	let warningBackgroundLight: ThemeColor | undefined = new ThemeColor('quantumErrorLens.warningBackgroundLight');
	const warningForeground = new ThemeColor('quantumErrorLens.warningForeground');
	const warningForegroundLight = new ThemeColor('quantumErrorLens.warningForegroundLight');
	let warningMessageBackground: ThemeColor | undefined = new ThemeColor('quantumErrorLens.warningMessageBackground');

	let infoBackground: ThemeColor | undefined = new ThemeColor('quantumErrorLens.infoBackground');
	let infoBackgroundLight: ThemeColor | undefined = new ThemeColor('quantumErrorLens.infoBackgroundLight');
	const infoForeground = new ThemeColor('quantumErrorLens.infoForeground');
	const infoForegroundLight = new ThemeColor('quantumErrorLens.infoForegroundLight');
	let infoMessageBackground: ThemeColor | undefined = new ThemeColor('quantumErrorLens.infoMessageBackground');

	let hintBackground: ThemeColor | undefined = new ThemeColor('quantumErrorLens.hintBackground');
	let hintBackgroundLight: ThemeColor | undefined = new ThemeColor('quantumErrorLens.hintBackgroundLight');
	const hintForeground = new ThemeColor('quantumErrorLens.hintForeground');
	const hintForegroundLight = new ThemeColor('quantumErrorLens.hintForegroundLight');
	let hintMessageBackground: ThemeColor | undefined = new ThemeColor('quantumErrorLens.hintMessageBackground');

	const statusBarErrorForeground = new ThemeColor('quantumErrorLens.statusBarErrorForeground');
	const statusBarWarningForeground = new ThemeColor('quantumErrorLens.statusBarWarningForeground');
	const statusBarInfoForeground = new ThemeColor('quantumErrorLens.statusBarInfoForeground');
	const statusBarHintForeground = new ThemeColor('quantumErrorLens.statusBarHintForeground');
