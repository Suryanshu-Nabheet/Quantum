...
const PROTO_PATH = path.resolve(import.meta.dirname, '../src/proto/quantum.proto')
...
const quantumProto = protoDescriptor.quantum.v1
...
async function main() {
  ...
  const client = new quantumProto.AgentService(
    `${host}:${port}`,
  ...
  console.log('\x1b[32mQuantum gRPC CLI\x1b[0m')
