...
export const CCR_TERMS_URL = 'https://github.com/Suryanshu-Nabheet/Quantum/blob/main/cli/README.md';
    ...
    try {
      ...
      if (executionTarget === 'remote') {
        ...
        enqueuePendingNotification({
          value: [`Ultraplan approved — executing in Quantum on the web. Follow along at: ${url}`, '', 'Results will land as a pull request when the remote session finishes. There is nothing to do here.'].join('\n'),
...
export default {
  type: 'local-jsx',
  name: 'ultraplan',
  description: `~10–30 min · Quantum on the web drafts an advanced plan you can edit and approve. See ${CCR_TERMS_URL}`,
  argumentHint: '<prompt>',
