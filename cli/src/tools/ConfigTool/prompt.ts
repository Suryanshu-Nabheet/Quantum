...
export const DESCRIPTION = 'Get or set Quantum CLI configuration settings.'
...
export function generatePrompt(): string {
  ...
  return `Get or set Quantum CLI configuration settings.

  View or change Quantum CLI settings. Use when the user requests configuration changes, asks about current settings, or when adjusting a setting would benefit them.
...
### Global Settings (stored in ~/.quantum.json)
${globalSettings.join('\n')}
