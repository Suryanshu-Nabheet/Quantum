...
const CRITIQUE_SYSTEM_PROMPT =
  'You are an expert reviewer of auto mode classifier rules for Quantum.\n' +
  '\n' +
  'Quantum has an "auto mode" that uses an AI classifier to decide whether ' +
  ...
  if (!hasCustomRules) {
    process.stdout.write(
      'No custom auto mode rules found.\n\n' +
        ...
        'Run `quantum auto-mode defaults` to see the default rules for reference.\n',
    )
    return
  }
