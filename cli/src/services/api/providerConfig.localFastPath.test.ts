...
const ENV_VAR = 'QUANTUM_LOCAL_FAST_PATH'
...
describe('getLocalFastPathConfig — explicit env override', () => {
  test('QUANTUM_LOCAL_FAST_PATH=1 forces on against a public host', () => {
  ...
  test('QUANTUM_LOCAL_FAST_PATH=0 forces off against localhost', () => {
