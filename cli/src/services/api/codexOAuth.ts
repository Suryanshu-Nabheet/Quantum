...
<html lang="en">
  ...
  <body>
    ...
    <p>You can return to Quantum now.</p>
    <p>Quantum will finish activating your new Codex OAuth login.</p>
  </body>
</html>`
}
...
<html lang="en">
  ...
  <body>
    ...
    <p>${safeMessage}</p>
    <p>You can close this window and try again in Quantum.</p>
  </body>
</html>`
}
...
<html lang="en">
  ...
  <body>
    ...
    <p>You can close this window and retry in Quantum.</p>
  </body>
</html>`
}
